...
var questions = [
    ...
    {
        id: 2,
    question: "His __________ in business matters often resulted in poor decisions, as he would take people at their word without verifying the facts.",
    chinese_question: "他在商业事务中的 __________ 常常导致糟糕的决定，因为他会不加核实事实就相信别人的话。",
    answers: [
    ...
    chinese_explanation: "(A) '天真' 意味着缺乏经验、智慧或判断力。" +
        "<br><br>" +
        "(B) '狡猾' 意味着在通过欺骗或规避实现目的方面具有或表现出技巧。" +
        "<br><br>" +
        "(C) '经验' 意味着实际接触和观察事实或事件。" +
        "<br><br>" +
        "(D) '谨慎' 意味着谨慎的品质。"
    },
    {
    ...
    {
        id: 4,
    question: "Her performance in the play was __________, capturing the essence of the character perfectly.",
    chinese_question: "她在戏剧中的表演是 __________ 的，完美地捕捉了角色的本质。",
    answers: [
    ...
    {
        id: 9,
        question: "Her speech was so __________ that it moved everyone in the audience to tears.",
        chinese_question: "她的演讲非常 __________，让在场的每个人都感动得流泪。",
        answers: [
            { option: "A", answer: "dull", chinese_answer: "乏味的", chinese_romanization: "fáwèi de" },
            { option: "B", answer: "potent", chinese_answer: "强有力的", chinese_romanization: "qiángyǒulì de" },
        ...
        chinese_explanation: "(B) '强有力的' 意味着具有强大力量、影响力或效果的。" +
            "<br><br>" +
            "(A) '乏味的' 意味着缺乏兴趣或兴奋的。" +
            "<br><br>" +
            "(C) '虚弱的' 意味着缺乏执行体力任务的力量；缺乏体力和精力的。" +
            "<br><br>" +
