...
chinese_explanation: "(B) '克制' 在比喻意义上指抑制自己不去表现或表达某事。" +
    ...
    {
        id: 3,
        question: "They did not __________ to the new rules, but accepted them without complaint and adjusted their routines accordingly.",
        chinese_question: "他们没有 __________ 新规则，而是毫无怨言地接受了它们，并相应地调整了他们的日常工作。",
        answers: [
    ...
    {
        id: 5,
        question: "The comedian is well-known for his ability to __________ jokes during his shows, often crafting humorous stories on the spot based on audience reactions.",
        chinese_question: "这位喜剧演员以能够在节目中 __________ 笑话而闻名，通常根据观众的反应即兴创作有趣的故事。",
        answers: [
    ...
    {
        id: 7,
        question: "The company’s conservative policies often __________ innovative ideas from younger employees by limiting their opportunities for creative expression and discouraging risk-taking.",
        chinese_question: "公司的保守政策经常通过限制年轻员工创造性表达的机会和阻碍冒险行为来 __________ 他们的创新想法。",
        answers: [
    ...
    {
        id: 8,
        question: "His ambiguous statement could be __________ in several different ways, like suggesting approval or implying criticism.",
        chinese_question: "他那含糊不清的陈述可以被 __________ 成几种不同的方式，比如暗示赞成或暗示批评。",
        answers: [
    ...
    },
    {
        ...
        answers: [
                ...
                { option: "C", answer: "reveal", chinese_answer: "揭露", chinese_romanization: "jiēlù" },
        ...
        explanation: "(B) 'feign' used figuratively means to pretend to have or feel something." +
            ...
            "<br><br>" +
            "(C) 'reveal' means to make known something that was previously unknown." +
            "<br><br>" +
            "(D) 'acknowledge' means to accept or admit the existence or truth of something.",
