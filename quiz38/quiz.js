...
var questions = [
    ...
    {
        id: 2,
    question: "The student gave a __________ glance at his failed test paper, clearly regretting not studying harder.",
    chinese_question: "学生对他不及格的试卷投以 __________ 的一瞥，显然后悔没有更努力地学习。",
    answers: [
        { option: "A", answer: "exultant", chinese_answer: "欢欣的", chinese_romanization: "huānxīn de" },
        { option: "B", answer: "blissful", chinese_answer: "幸福的", chinese_romanization: "xìngfú de" },
        { option: "C", answer: "ebullient", chinese_answer: "热情洋溢的", chinese_romanization: "rèqíng yángyì de" },
        { option: "D", answer: "rueful", chinese_answer: "悔恨的", chinese_romanization: "huǐhèn de" }
    ],
    correctAnswer: "D",
    explanation: "(D) 'rueful' means expressing sorrow or regret, especially in a slightly humorous way." +
        "<br><br>" +
        "(A) 'exultant' means triumphantly happy." +
        "<br><br>" +
        "(B) 'blissful' means extremely happy; full of joy." +
        "<br><br>" +
        "(C) 'ebullient' means cheerful and full of energy.",
    chinese_explanation: "(D) '悔恨的' 意思是表达悲伤或后悔，尤其是带有些许幽默的方式。" +
        "<br><br>" +
        "(A) '欢欣的' 意思是胜利的快乐。" +
        "<br><br>" +
        "(B) '幸福的' 意思是非常快乐；充满喜悦。" +
    ...
    {
        id: 6,
    question: "In their household, Sunday family dinners were considered __________, with everyone expected to attend without exception.",
    chinese_question: "在他们的家里，周日的家庭晚餐被视为 __________，所有人都必须参加，无一例外。",
    answers: [
        { option: "A", answer: "profane", chinese_answer: "亵渎的", chinese_romanization: "xièdú de" },
        { option: "B", answer: "irreverent", chinese_answer: "不敬的", chinese_romanization: "bùjìng de" },
        { option: "C", answer: "blasphemous", chinese_answer: "亵渎神明的", chinese_romanization: "xièdú shénmíng de" },
        { option: "D", answer: "sacrosanct", chinese_answer: "神圣不可侵犯的", chinese_romanization: "shénshèng bùkě qīnfàn de" }
    ],
    correctAnswer: "D",
    explanation: "(D) 'sacrosanct' means regarded as too important or valuable to be interfered with." +
        "<br><br>" +
        "(A) 'profane' means showing disrespect toward sacred things." +
        "<br><br>" +
        "(B) 'irreverent' means showing a lack of respect for people or things that are generally taken seriously." +
        "<br><br>" +
        "(C) 'blasphemous' means showing disrespect or lack of reverence for God or something sacred.",
    chinese_explanation: "(D) '神圣不可侵犯的' 意思是被认为太重要或有价值而不能受到干涉。" +
        "<br><br>" +
        "(A) '亵渎的' 意思是对神圣事物表示不敬。" +
        "<br><br>" +
        "(B) '不敬的' 意思是对人或事物缺乏尊重，这些人或事物通常被认真对待。" +
        "<br><br>" +
        "(C) '亵渎神明的' 意思是对上帝或神圣事物表示不敬或缺乏尊重。"
    },
    {
        id: 7,
    ...
    {
        id: 8,
    question: "The historical account of the battle was shockingly __________, describing the gruesome violence and countless casualties in detail.",
    chinese_question: "这场战斗的历史记述充满了 __________ 的描述，详细讲述了残酷的暴力和无数的伤亡。",
    answers: [
        { option: "A", answer: "peaceable", chinese_answer: "平和的", chinese_romanization: "pínghé de" },
        { option: "B", answer: "nonviolent", chinese_answer: "非暴力的", chinese_romanization: "fēi bàolì de" },
        { option: "C", answer: "pacifistic", chinese_answer: "和平主义的", chinese_romanization: "hépíng zhǔyì de" },
        { option: "D", answer: "sanguinary", chinese_answer: "血腥的", chinese_romanization: "xuèxīng de" }
    ],
    correctAnswer: "D",
    explanation: "(D) 'sanguinary' means involving or causing much bloodshed." +
        "<br><br>" +
        "(A) 'peaceable' means inclined to avoid conflict or violence." +
        "<br><br>" +
        "(B) 'nonviolent' means using peaceful means rather than force, especially to bring about political or social change." +
        "<br><br>" +
        "(C) 'pacifistic' means holding the belief that violence and war are unjustifiable.",
    chinese_explanation: "(D) '血腥的' 意思是涉及或引起大量流血。" +
        "<br><br>" +
        "(A) '平和的' 意思是倾向于避免冲突或暴力。" +
        "<br><br>" +
        "(B) '非暴力的' 意思是使用和平手段而不是武力，尤其是为了实现政治或社会变革。" +
        "<br><br>" +
        "(C) '和平主义的' 意思是认为暴力和战争是不正当的。"
    },
    {
        id: 9,
