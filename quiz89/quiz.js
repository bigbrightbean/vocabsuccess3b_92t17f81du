...
var questions = [
    {
        id: 1,
        question: "The cab driver's constant __________ about the traffic and other drivers made the ride very unpleasant for the passengers.",
        chinese_question: "出租车司机对交通和其他司机不断的__________让乘客的旅程非常不愉快。",
        answers: [
            ...
            { option: "C", answer: "compliment", chinese_answer: "恭维", chinese_romanization: "gōngwèi" },
...
chinese_explanation: "(A) '关键人物' 意味着对企业或组织至关重要的人或事物。" +
    ...
    {
        id: 8,
        question: "He took __________ at the joke and responded angrily, believing it was aimed at him.",
        chinese_question: "他对这个笑话感到 __________ 并愤怒回应，认为这是针对他的。",
        answers: [
