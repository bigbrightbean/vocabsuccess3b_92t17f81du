...
var questions = [
    ...
    {
        id: 4,
        question: "The __________ book, praised by critics and readers alike, inspired a generation of activists.",
        chinese_question: "这本受到评论家和读者一致好评的 __________ 书启发了一代活动家。",
        answers: [
    ...
    {
        id: 6,
        question: "His __________ leadership guided the team to unprecedented success, setting new benchmarks.",
        chinese_question: "他的 __________ 领导带领团队取得了前所未有的成功，树立了新的基准。",
        answers: [
    ...
    {
        id: 7,
    question: "His __________ nature made him the ideal candidate for the project, as the team could always count on him to meet deadlines.",
