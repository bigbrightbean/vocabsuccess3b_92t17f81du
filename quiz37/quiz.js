...
var questions = [
    ...
    {
        id: 6,
        question: "The chef's __________ senses were highly developed, allowing him to distinguish subtle differences in spices and herbs.",
        chinese_question: "这位厨师的 __________ 感非常发达，使他能够分辨香料和草药的微妙差异。",
        answers: [
    ...
    {
        id: 7,
        question: "Her __________ manner at the party, constantly bragging about her wealth, alienated many of the guests.",
        chinese_question: "她在聚会上 __________ 的举止，不断炫耀她的财富，使许多客人感到疏远。",
        answers: [
    ...
    {
        id: 9,
        question: "The company's __________ approach to innovation kept them ahead of competitors.",
        chinese_question: "公司__________的创新方式使他们领先于竞争对手。",
        answers: [
        ...
        correctAnswer: "D",
        explanation: "(D) 'sprightly' means lively; full of energy." +
            "<br><br>" +
            ...
            "<br><br>" +
            "(C) 'indifferent' means having no particular interest or sympathy; unconcerned.",
        chinese_explanation: "(D) '活泼的'一词意味着充满活力的。" +
            "<br><br>" +
