...
var questions = [
    ...
    {
        id: 2,
        question: "His __________ handling of the situation caused more problems than it solved.",
        chinese_question: "他__________地处理情况，导致了更多的问题而不是解决问题。",
        answers: [
    ...
    {
        id: 3,
        question: "Her instructions were __________, leaving no room for misinterpretation.",
        chinese_question: "她的指示是__________的，不会留下任何误解的余地。",
        answers: [
