...
var questions = [
    {
        id: 1,
        question: "Despite his anxiety, he tried to __________ his true feelings by putting on a brave face and acting confidently.",
        chinese_question: "尽管他很焦虑，他试图通过装出勇敢的样子和自信的表现来 __________ 自己的真实感受。",
        answers: [
...
chinese_explanation: "(A) '遵守' 意味着符合或遵守。" +
    ...
    explanation: "(B) 'emend' means to make corrections or improvements to a text." +
        "<br><br>" +
        "(A) 'overlook' means to fail to notice or consider." +
        "<br><br>" +
        "(C) 'praise' means to express warm approval or admiration of." +
        "<br><br>" +
        "(D) 'distort' means to twist or change the shape or meaning of something.",
    chinese_explanation: "(B) '修改' 意味着对文本进行更正或改进。" +
        ...
        "(C) '赞美' 意味着表达热烈的认可或钦佩。" +
        "<br><br>" +
        "(D) '扭曲' 意味着扭转或改变某物的形状或意义。"
    },
    {
        id: 5,
        question: "The writer felt __________ by the publisher's strict guidelines because it meant that he had to compromise his creative vision and adhere to specific standards.",
        chinese_question: "作家觉得被出版商的严格指导方针 __________，因为这意味着他不得不妥协自己的创作愿景并遵守特定标准。",
        answers: [
    ...
    {
        id: 6,
        question: "The authorities decided to __________ him and return him to prison for violating the terms of his parole.",
        chinese_question: "当局决定因为他违反假释条款而 __________ 他，并将他送回监狱。",
        answers: [
  ...
  chinese_explanation: "(A) '利用' 意味着利用（情况）；充分利用。" +
    ...
    {
        id: 8,
  question: "The passing of time did not __________ his memory of the joyful event; instead, it remained as vivid as ever.",
  chinese_question: "时间的流逝并没有 __________ 他对那场欢乐事件的记忆，反而它依然那么生动。",
  answers: [
...
chinese_explanation: "(B) '拖延' 一词在比喻上意味着延迟或停留。" +
    ...
    {
        id: 10,
        question: "The team needed more time to __________ their strategy for the competition and ensure every detail was perfect.",
        chinese_question: "团队需要更多的时间来 __________ 他们的比赛策略，以确保每一个细节都是完美的。",
        answers: [
