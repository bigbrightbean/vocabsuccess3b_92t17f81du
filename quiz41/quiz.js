...
var questions = [
    ...
    {
        id: 7,
    question: "Known for his __________ elegance, the fashion designer always appeared impeccably dressed, setting trends with his unique sense of style.",
    chinese_question: "这位时装设计师以其 __________ 的优雅着称，他总是穿着得体，以独特的风格引领潮流。",
    answers: [
        { option: "A", answer: "slovenly", chinese_answer: "邋遢的", chinese_romanization: "lātà de" },
        { option: "B", answer: "unkempt", chinese_answer: "不整洁的", chinese_romanization: "bùzhěngjié de" },
        { option: "C", answer: "disheveled", chinese_answer: "凌乱的", chinese_romanization: "língluàn de" },
        { option: "D", answer: "sartorial", chinese_answer: "服装的", chinese_romanization: "fúzhuāng de" }
    ],
    correctAnswer: "D",
    explanation: "(D) 'sartorial' means relating to tailoring, clothes, or style of dress." +
        "<br><br>" +
        "(A) 'slovenly' means messy and dirty." +
        "<br><br>" +
        "(B) 'unkempt' means having an untidy or disheveled appearance." +
        "<br><br>" +
        "(C) 'disheveled' means untidy; disordered.",
    chinese_explanation: "(D) '服装的' 意思是与裁缝、服装或穿着风格有关。" +
        "<br><br>" +
        "(A) '邋遢的' 意思是凌乱和肮脏的。" +
        "<br><br>" +
        "(B) '不整洁的' 意思是外表不整洁或凌乱。" +
