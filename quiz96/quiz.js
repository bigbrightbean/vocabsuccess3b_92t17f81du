...
var questions = [
    ...
    {
        id: 2,
        question: "When asked about the missing funds, the manager began to __________, giving vague and misleading answers to avoid the truth.",
        chinese_question: "当被问及丢失的资金时，经理开始 __________，给出模糊和误导性的回答以避免说出真相。",
        answers: [
            ...
            { option: "D", answer: "prevaricate", chinese_answer: "搪塞", chinese_romanization: "tángsè" }
        ],
        correctAnswer: "D",
        explanation: "(D) 'prevaricate' means to avoid telling the truth by not directly answering a question." +
            "<br><br>" +
            "(A) 'confess' means to admit something honestly." +
            "<br><br>" +
            "(B) 'disclose' means to make something known publicly." +
            "<br><br>" +
            "(C) 'reveal' means to show or tell something that was hidden.",
        chinese_explanation: "(D) '搪塞' 意味着通过不直接回答问题来避免说出真相。" +
            "<br><br>" +
            "(A) '坦白' 意味着诚实地承认某事。" +
            "<br><br>" +
            "(B) '披露' 意味着公开某事。" +
    ...
    {
        id: 5,
        question: "The evidence presented in court helped to __________ the defendant of all charges so that he could regain his freedom and reputation.",
        chinese_question: "法庭上提供的证据帮助 __________ 被告所有的指控，使他能够重获自由和名誉。",
        answers: [
    ...
    {
        id: 6,
        question: "Her account of the events was __________ by several other witnesses who also saw the incident and confirmed her description.",
        chinese_question: "她对事件的描述得到了几位其他证人的 __________，这些证人也看到了事件并确认了她的描述。",
        answers: [
    ...
    {
        id: 7,
    question: "When summoned, the knight would __________ before the king as a sign of respect because no one was allowed to remain standing in the king's presence.",
    chinese_question: "当被召唤时，骑士会在国王面前 __________ 以示尊敬，因为没有人被允许在国王面前站立。",
    answers: [
    ...
    {
        id: 10,
    question: "The new judge made it his mission to __________ the new regulations by holding public meetings and distributing pamphlets, ensuring that everyone in the court understood the updated laws clearly and comprehensively.",
    chinese_question: "新任法官通过召开公开会议和分发小册子将宣布新规定作为他的使命，确保法庭上的每个人都清楚全面地理解更新后的法律。",
    answers: [
        { option: "A", answer: "conceal", chinese_answer: "隐瞒", chinese_romanization: "yǐnmán" },
        ...
        { option: "D", answer: "promulgate", chinese_answer: "宣布", chinese_romanization: "xuānbù" }
    ],
    correctAnswer: "D",
    explanation: "(D) 'promulgate' means to make a new law or regulation known to the public." +
        "<br><br>" +
        "(A) 'conceal' means to keep something hidden." +
        "<br><br>" +
        "(B) 'suppress' means to stop or prevent something from being seen or expressed." +
        "<br><br>" +
        "(C) 'obscure' means to make something unclear or difficult to understand.",
    chinese_explanation: "(D) '宣布' 意味着将新的法律或规定告知公众。" +
        "<br><br>" +
        "(A) '隐瞒' 意味着把某事隐藏起来。" +
        "<br><br>" +
        "(B) '压制' 意味着阻止或防止某事被看到或表达。" +
        "<br><br>" +
        "(C) '模糊' 意味着使某事不清楚或难以理解。"
    }
];
