...
var questions = [
    {
        id: 1,
    question: "She began to __________ under the strict rules imposed by her parents.",
    chinese_question: "在父母施加的严格规则下，她开始 __________。",
    answers: [
    ...
    {
        id: 2,
        question: "During the interview, she began to __________ when asked about her previous job experience.",
        chinese_question: "在面试中，当被问及她的以前的工作经历时，她开始 __________。",
        answers: [
    ...
    {
        id: 3,
question: "She hoped to __________ her colleague's anger by explaining the misunderstanding.",
chinese_question: "她希望通过解释误会来 __________ 同事的愤怒。",
answers: [
...
chinese_explanation: "(B) '安抚' 意味着安慰或平息某人的愤怒或焦虑。" +
    ...
    {
        id: 4,
        question: "The invading army began to __________ the village, taking everything of value.",
        chinese_question: "入侵的军队开始 __________ 村庄，抢走所有有价值的东西。",
        answers: [
    ...
    {
        id: 5,
    question: "The politician tried to __________ his way into the voters' hearts with promises of change.",
    chinese_question: "政治家试图通过承诺改变来 __________ 选民的心。",
    answers: [
    ...
    {
        id: 6,
        question: "The chef’s assistant accidentally __________ the recipe, ruining the dish.",
        chinese_question: "厨师的助手不小心 __________ 了食谱，毁了这道菜。",
        answers: [
    ...
    {
        id: 7,
        question: "The rapid advancements in technology __________ the older generation.",
        chinese_question: "科技的快速进步让老一辈人 __________ 。",
        answers: [
    ...
    {
        id: 8,
        question: "The manager __________ his team to complete the project before the deadline.",
        chinese_question: "经理 __________ 他的团队在截止日期前完成项目。",
        answers: [
    ...
    {
        id: 9,
question: "The pristine waters of the lake were __________ by the illegal dumping of waste.",
chinese_question: "湖泊的清澈水域因非法倾倒垃圾而被 __________ 了。",
answers: [
...
chinese_explanation: "(B) '玷污' 意味着损害纯洁性或完整性；玷污。" +
    ...
    {
        id: 10,
        question: "She had no reason to __________ the decision as it was clearly in everyone's best interest.",
        chinese_question: "她没有理由 __________ 这个决定，因为这显然符合每个人的最佳利益。",
        answers: [
