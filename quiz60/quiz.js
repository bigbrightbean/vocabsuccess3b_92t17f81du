...
var questions = [
    {
        id: 1,
        question: "The __________ focus of the lecture, with no other topics discussed, was on the importance of biodiversity.",
        chinese_question: "讲座的 __________ 重点，且没有讨论其他话题，是生物多样性的重要性。",
        answers: [
...
chinese_explanation: "(C) '轻快' 意味着快速和充满活力的。" + 
    ...
    {
        id: 7,
    question: "Her __________ belief in the goodness of all people and their intentions often led her to be taken advantage of.",
    chinese_question: "她对所有人及其意图善良的 __________ 信念常常使她被利用。",
    answers: [
    ...
    {
        id: 8,
        question: "The __________ decision about the new policy will be made by the board of directors because they have the authority and responsibility to make final decisions.",
        chinese_question: "关于新政策的 __________ 决定将由董事会做出，因为他们有权力和责任做出最终决定。",
        answers: [
    ...
    {
        id: 10,
        question: "His __________ questioning, such as repeatedly asking the same questions and interrupting the witness, made the witness feel increasingly uncomfortable.",
        chinese_question: "他 __________ 的质问，例如反复问同样的问题并打断证人的话，让证人感到越来越不舒服。",
        answers: [
