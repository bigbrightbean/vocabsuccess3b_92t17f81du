...
var questions = [
    ...
    {
        id: 3,
        question: "The surveyors needed to __________ the boundaries of the new property clearly so that there would be no disputes with neighboring properties.",
        chinese_question: "测量员需要清晰地 __________ 新物业的边界，以避免与邻近物业发生纠纷。",
        answers: [
    ...
    {
        id: 6,
        question: "The historian explained how invaders would __________ the countryside during times of war by looting and burning villages.",
        chinese_question: "历史学家解释了入侵者如何在战争期间通过掠夺和焚烧村庄 __________ 乡村。",
        answers: [
    ...
    {
        id: 10,
        question: "The oppressive heat had __________ the soldiers, making it difficult for them to continue marching without feeling exhausted and dehydrated like wilted plants.",
        chinese_question: "闷热的天气使士兵们 __________ ，使他们难以继续行军而不会感到筋疲力尽和脱水，像枯萎的植物一样。",
        answers: [
