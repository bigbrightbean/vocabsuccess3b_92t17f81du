...
var questions = [
    ...
    {
        id: 4,
        question: "His __________ manner in handling the criticism earned him a lot of respect.",
        chinese_question: "他 __________ 地处理批评的方式赢得了很多人的尊敬。",
        answers: [
    ...
    {
        id: 7,
    question: "The CEO's __________ lifestyle was often criticized as being out of touch with the average employee.",
    chinese_question: "CEO的 __________ 生活方式经常被批评为脱离普通员工的实际。",
    answers: [
    ...
    {
        id: 9,
        question: "Investing in government bonds is considered a __________ bet in the financial market.",
        chinese_question: "投资政府债券被认为是在金融市场上的一个 __________ 的赌注。",
        answers: [
    ...
    {
        id: 10,
        question: "His __________ approach to the negotiations led him to accept unfavorable terms.",
