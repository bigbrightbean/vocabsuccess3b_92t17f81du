...
var questions = [
    {
        id: 1,
    question: "The community was quick to __________ the outsider, publicly condemning his actions and shunning him from all social activities because of his controversial opinions.",
    chinese_question: "社区很快就对外来者进行了 __________，公开谴责他的行为并将他排除在所有社交活动之外，因为他的意见具有争议性。",
    answers: [
        ...
        { option: "D", answer: "anathematize", chinese_answer: "诅咒", chinese_romanization: "zǔzhòu" }
    ],
    correctAnswer: "D",
    explanation: "(D) 'anathematize' means to strongly dislike or criticize someone." +
        "<br><br>" +
        "(A) 'embrace' means to accept someone warmly and gladly." +
        "<br><br>" +
        "(B) 'welcome' means to greet someone in a friendly way." +
        "<br><br>" +
        "(C) 'praise' means to say good things about someone.",
    chinese_explanation: "(D) '诅咒' 意味着强烈地不喜欢或批评某人。" +
        "<br><br>" +
        "(A) '拥抱' 意味着热情地接受某人。" +
        "<br><br>" +
        "(B) '欢迎' 意味着以友好的方式迎接某人。" +
...
chinese_explanation: "(A) '放弃' 意味着同意放弃或不做某事。" +
    ...
    {
        id: 3,
    question: "The principal decided to __________ the use of cell phones during school hours so no one would be distracted by notifications and social media.",
    chinese_question: "校长决定在上课期间 __________ 使用手机，这样就不会有人被通知和社交媒体分心。",
    answers: [
    ...
    {
        id: 5,
        question: "The unexpected road construction will __________ commuters because they will face delays and detours, making their journeys longer and more frustrating.",
        chinese_question: "意外的道路施工会 __________ 通勤者，因为他们将面临延误和绕行，使他们的行程更长且更加令人沮丧。",
        answers: [
    ...
    {
        id: 8,
        question: "The monk would __________ himself with a whip until he bled as a form of penance.",
        chinese_question: "这位僧侣会用鞭子 __________ 自己直到流血以示忏悔。",
        answers: [
    ...
    {
        id: 9,
        question: "The sailor began to __________ the sails by rolling them up and securing them with ropes as the storm approached so that they wouldn't tear and cause the ship to lose control.",
        chinese_question: "风暴临近时，水手开始通过卷起帆并用绳子固定来 __________ 帆，以免帆被撕裂并导致船失去控制。",
        answers: [
