...
var questions = [
    ...
    {
        id: 2,
        question: "The company offers competitive interest __________ on all savings accounts.",
        chinese_question: "公司为所有储蓄账户提供有竞争力的利率。",
        answers: [
            { option: "A", answer: "services", chinese_answer: "服务", chinese_romanization: "fúwù" },
            { option: "B", answer: "plans", chinese_answer: "计划", chinese_romanization: "jìhuà" },
            { option: "C", answer: "rates", chinese_answer: "利率", chinese_romanization: "lìlǜ" },
            { option: "D", answer: "errors", chinese_answer: "错误", chinese_romanization: "cuòwù" }
        ],
        correctAnswer: "C",
        explanation: "(C) 'rates' means a measure, quantity, or frequency, typically one measured against another quantity or measure." +
                "<br><br>" +
                "(A) 'services' means the action of helping or doing work for someone." +
                "<br><br>" +
                "(B) 'plans' means a detailed proposal for doing or achieving something." +
                "<br><br>" +
                "(D) 'errors' means mistakes.",
        chinese_explanation: "(C) '利率' 意味着一种度量、数量或频率，通常与另一数量或度量相比较。" +
                "<br><br>" +
                "(A) '服务' 意味着帮助或为某人做工作的行为。" +
                "<br><br>" +
                "(B) '计划' 意味着做某事或实现某事的详细提议。" +
                "<br><br>" +
                "(D) '错误' 意味着错误。"
    },
    {
    ...
    {
        id: 7,
        question: "The company saw a significant __________ in profits after launching the new product line.",
        chinese_question: "公司在推出新产品线后利润显著 __________。",
        answers: [
        ...
        explanation: "(A) 'increase' means a rise in the amount, number, or value of something." +
                ...
                "<br><br>" +
                "(C) 'stagnation' means a state of not flowing or moving." +
                "<br><br>" +
        ...
        chinese_explanation: "(A) '增加' 意味着某物的数量、数目或价值的上升。" +
                ...
                "(C) '停滞' 意味着不流动或不移动的状态。" +
                "<br><br>" +
                "(D) '减少' 意味着使某物在数量、程度或大小上变小或减少的行为或事实。"
    },
    {
        id: 8,
