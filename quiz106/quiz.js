...
var questions = [
    ...
    {
        id: 4,
    question: "When his parents asked about his future plans, he __________, saying he needed more time to think instead of giving a clear answer.",
    chinese_question: "当他的父母询问他的未来计划时，他__________，说他需要更多时间思考，而不是给出明确的答案。",
    answers: [
        { option: "A", answer: "decided", chinese_answer: "决定了", chinese_romanization: "juédìng le" },
        { option: "B", answer: "committed", chinese_answer: "承诺了", chinese_romanization: "chéngnuò le" },
        { option: "C", answer: "resolved", chinese_answer: "解决了", chinese_romanization: "jiějué le" },
        { option: "D", answer: "temporized", chinese_answer: "拖延了", chinese_romanization: "tuōyán le" }
    ],
    correctAnswer: "D",
    explanation: "(D) 'temporized' means to delay making a decision or giving an answer, often to gain more time." +
        "<br><br>" +
        "(A) 'decided' means to have chosen something after thinking." +
        "<br><br>" +
        "(B) 'committed' means to have promised to do something." +
        "<br><br>" +
        "(C) 'resolved' means to have found a solution to a problem.",
    chinese_explanation: "(D) '拖延了' 的意思是推迟做决定或给出答案，通常是为了争取更多时间。" +
        "<br><br>" +
        "(A) '决定了' 的意思是经过思考后做出了选择。" +
        "<br><br>" +
        "(B) '承诺了' 的意思是答应做某事。" +
        "<br><br>" +
        "(C) '解决了' 的意思是找到了解决问题的方法。"
    },
    {
        id: 5,
    ...
    {
        id: 6,
    question: "The company aims to __________ its brand by launching a new advertising campaign to reconnect with former customers and attract a younger audience.",
    chinese_question: "公司计划通过启动一项新的广告活动来 __________ 其品牌，以重新联系以前的客户并吸引年轻观众。",
    answers: [
    ...
    {
        id: 7,
        question: "Over the years, the riverbed began to __________ due to mineral deposits, becoming increasingly hard and less permeable.",
        chinese_question: "多年来，由于矿物沉积，河床开始 __________ ，变得越来越硬且不透水。",
        answers: [
    ...
    {
        id: 8,
        question: "She decided to __________ a minimalist lifestyle, getting rid of unnecessary possessions and focusing on experiences over material things.",
        chinese_question: "她决定 __________ 极简主义的生活方式，摆脱不必要的物品，并专注于体验而非物质。",
        answers: [
    ...
    {
        id: 10,
        question: "The store owner had to __________ carefully before deciding whether to open a new branch, as it was a big decision.",
        chinese_question: "店主在决定是否开设新分店之前需要仔细__________，因为这是一个重大的决定。",
        answers: [
            { option: "A", answer: "guess", chinese_answer: "猜测", chinese_romanization: "cāicè" },
            { option: "B", answer: "dismiss", chinese_answer: "不予考虑", chinese_romanization: "bùyǔ kǎolǜ" },
            { option: "C", answer: "overlook", chinese_answer: "忽略", chinese_romanization: "hūlüè" },
            { option: "D", answer: "cogitate", chinese_answer: "仔细思考", chinese romanization: "zǐxì sīkǎo" }
        ],
        correctAnswer: "D",
        explanation: "(D) 'cogitate' means to think deeply and carefully about something." +
            "<br><br>" +
            "(A) 'guess' means to try to give an answer without knowing if it is right." +
            "<br><br>" +
            "(B) 'dismiss' means to decide that something is not worth thinking about." +
            "<br><br>" +
            "(C) 'overlook' means to fail to notice or consider something.",
        chinese_explanation: "(D) '仔细思考' 的意思是认真地思考某事。" +
            "<br><br>" +
            "(A) '猜测' 的意思是试图给出一个答案，但不确定是否正确。" +
            "<br><br>" +
            "(B) '不予考虑' 的意思是决定某事不值得考虑。" +
            "<br><br>" +
            "(C) '忽略' 的意思是未能注意或考虑某事。"
    }
];
