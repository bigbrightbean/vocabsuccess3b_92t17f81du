...
var questions = [
    ...
    {
        id: 2,
        question: "The accountant was caught trying to __________ funds from the company’s accounts by creating false invoices and manipulating records.",
        chinese_question: "会计被抓到试图通过制作虚假发票和篡改记录，从公司的账户中 __________ 资金。",
        answers: [
    ...
    {
        id: 4,
    question: "At the end of the tour, the guide made sure to __________ the main points of interest, summarizing the historical significance of each location they visited.",
    chinese_question: "在旅游结束时，导游确保 __________ 主要景点，总结他们参观的每个地方的历史意义。",
    answers: [
        ...
        { option: "D", answer: "recapitulate", chinese_answer: "总结", chinese_romanization: "zǒngjié" }
    ],
    correctAnswer: "D",
    explanation: "(D) 'recapitulate' means to summarize and repeat the main points." +
        "<br><br>" +
        "(A) 'obscure' means to make something unclear or difficult to understand." +
        "<br><br>" +
        "(B) 'complicate' means to make something more difficult or complex." +
        "<br><br>" +
        "(C) 'confuse' means to make someone unable to think clearly or understand.",
    chinese_explanation: "(D) '总结' 意味着总结和重复主要观点。" +
        "<br><br>" +
        "(A) '模糊' 意味着使某事不清楚或难以理解。" +
        "<br><br>" +
        "(B) '复杂化' 意味着使某事更加困难或复杂。" +
        "<br><br>" +
        "(C) '混淆' 意味着使某人无法清楚地思考或理解。"
    },
    {
        id: 5,
