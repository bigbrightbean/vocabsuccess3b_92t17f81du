...
chinese_explanation: "(A) '边缘的' 意味着次要的或不重要的；不核心的。" + 
    ...
    {
        id: 10,
    question: "His careless remarks __________ his chances of getting the promotion.",
    chinese_question: "他的随意言论__________了他升职的机会。",
    answers: [
        { option: "A", answer: "ensured", chinese_answer: "确保", chinese_romanization: "quèbǎo" },
        { option: "B", answer: "secured", chinese_answer: "保护", chinese_romanization: "bǎohù" },
        { option: "C", answer: "jeopardized", chinese_answer: "危及", chinese_romanization: "wēijí" },
        { option: "D", answer: "protected", chinese_answer: "保护", chinese_romanization: "bǎohù" }
    ],
    correctAnswer: "C",
    explanation: "(C) 'jeopardized' means put (someone or something) into a situation in which there is a danger of loss, harm, or failure. Figuratively, it can mean risking or endangering." + 
        "<br><br>" +
        "(A) 'ensured' means made certain that (something) shall occur or be the case." +
        "<br><br>" +
        "(B) 'secured' means fixed or fastened so as not to give way, become loose, or be lost." +
        "<br><br>" +
        "(D) 'protected' means kept safe from harm or injury.",
    chinese_explanation: "(C) '危及'一词意味着将（某人或某事）置于有危险的情况中，可能会导致损失、伤害或失败。比喻地，它可以表示冒险或危害。" + 
        "<br><br>" +
        "(A) '确保' 意味着确保（某事）将发生或成为现实。" +
        "<br><br>" +
        "(B) '保护' 意味着固定或固定，以免松动或丢失。" +
        "<br><br>" +
        "(D) '保护' 意味着保持安全免受伤害或伤害。"
    }
];
