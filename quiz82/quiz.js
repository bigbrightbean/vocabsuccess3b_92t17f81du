...
var questions = [
    {
        id: 1,
        question: "The project cannot proceed without the board’s __________, which is necessary for final approval.",
        chinese_question: "该项目需要董事会的 __________ 才能进行，这是最终批准所必需的。",
        answers: [
                { option: "A", answer: "imprimatur", chinese_answer: "认可", chinese_romanization: "rènkě" },
                { option: "B", answer: "objection", chinese_answer: "反对", chinese_romanization: "fǎnduì" },
                { option: "C", answer: "veto", chinese_answer: "否决", chinese_romanization: "fǒujué" },
                { option: "D", answer: "postponement", chinese_answer: "推迟", chinese_romanization: "tuīchí" }
        ],
        correctAnswer: "A",
        explanation: "(A) 'imprimatur' means an official license to print or publish a book, indicating approval." +
                "<br><br>" +
                "(B) 'objection' means an expression or feeling of disapproval or opposition." +
                "<br><br>" +
                "(C) 'veto' means a constitutional right to reject a decision or proposal made by a law-making body." +
                "<br><br>" +
                "(D) 'postponement' means the action of delaying something.",
        chinese_explanation: "(A) '认可'一词意味着印刷或出版书籍的官方许可，表示批准。" +
                "<br><br>" +
                "(B) '反对' 意味着不赞成或反对的表达或感觉。" +
                "<br><br>" +
                "(C) '否决' 意味着有权拒绝立法机构作出的决定或提议。" +
                "<br><br>" +
                "(D) '推迟' 意味着延迟某事的行为。"
    },
    {
