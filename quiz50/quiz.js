...
var questions = [
    ...
    {
        id: 4,
        question: "His __________ attempt to cheat on the exam was easily noticed by the invigilator, who spotted him openly looking at his notes and whispering answers to others.",
        chinese_question: "他 __________ 地企图在考试中作弊，很容易被监考员发现，因为监考员看到了他公然看笔记和对别人小声说答案。",
        answers: [
    ...
    {
        id: 6,
    question: "The speaker's __________ delivery kept the audience engaged, as he infused his talk with humor and enthusiasm.",
    chinese_question: "演讲者__________的演讲方式吸引了观众的注意，因为他在演讲中融入了幽默和热情。",
    answers: [
        { option: "A", answer: "monotonous", chinese_answer: "单调的", chinese_romanization: "dāndiào de" },
        { option: "B", answer: "tedious", chinese_answer: "冗长乏味的", chinese_romanization: "rǒngcháng fáwèi de" },
        { option: "C", answer: "drab", chinese_answer: "沉闷的", chinese_romanization: "chénmèn de" },
        { option: "D", answer: "zesty", chinese_answer: "充满活力的", chinese_romanization: "chōngmǎn huólì de" }
    ],
    correctAnswer: "D",
    explanation: "(D) 'zesty' means lively and exciting, especially in a manner that is stimulating or invigorating." +
        "<br><br>" +
        "(A) 'monotonous' means dull and repetitive, lacking in variety." +
        "<br><br>" +
        "(B) 'tedious' means too long, slow, or dull; tiresome." +
        "<br><br>" +
        "(C) 'drab' means lacking brightness or interest; drearily dull.",
    chinese_explanation: "(D) '充满活力的' 意思是生动有趣，特别是以令人兴奋或振奋的方式。" +
        "<br><br>" +
        "(A) '单调的' 意思是单调重复，缺乏变化。" +
        "<br><br>" +
        "(B) '冗长乏味的' 意思是过长、缓慢或沉闷的；乏味的。" +
        "<br><br>" +
        "(C) '沉闷的' 意思是缺乏亮点或兴趣；沉闷的。"
    },
    {
        id: 7,
    question: "Their __________ relationship, marked by thoughtful gestures like sharing constructive feedback and celebrating each other's achievements, made working together a pleasant experience.",
    chinese_question: "他们的__________关系，以体贴的举动为标志，如分享建设性的反馈和庆祝彼此的成就，使一起工作成为一种愉快的经历。",
    answers: [
    ...
    {
        id: 10,
        question: "After years of experience, she developed a __________ approach to solving complex problems, such as navigating corporate politics and designing intricate systems, that younger and more inexperienced colleagues often struggled with.",
        chinese_question: "经过多年的经验，她形成了 __________ 的方法来解决复杂问题，比如应对公司政治和设计复杂系统，这些问题是年轻且经验不足的同事常常难以处理的。",
        answers: [
