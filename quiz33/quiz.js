...
var questions = [
    ...
    {
        id: 5,
        question: "His __________ hospitality, such as offering personalized welcome gifts and preparing special meals, made all the guests feel welcomed and comfortable during their stay.",
        chinese_question: "他的 __________ 热情好客，比如提供个性化的欢迎礼物和准备特别的餐点，使所有客人在逗留期间都感到受欢迎和舒适。",
        answers: [
    ...
    {
        id: 8,
        question: "The company is __________ to market changes and quickly adapts its strategies to meet new demands and stay competitive.",
        chinese_question: "公司对市场变化非常 __________，并迅速调整其策略以满足新需求并保持竞争力。",
        answers: [
    ...
    {
        id: 9,
        question: "At first, the team was not receptive to the idea, but it was made more __________ with clear explanations on its benefits and implementation.",
        chinese_question: "起初，团队对这个想法并不接受，但通过清楚地解释其好处和实施，这个想法变得更加 __________。",
        answers: [
    ...
    {
        id: 10,
        question: "Always lifting everyone's spirits with her lively conversation and upbeat energy, her __________ personality made her the life of the party.",
        chinese_question: "总是通过她活泼的谈话和积极向上的能量提升每个人的精神，她 __________ 的性格使她成为聚会的灵魂。",
        answers: [
