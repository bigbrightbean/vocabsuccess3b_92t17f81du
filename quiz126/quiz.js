...
var questions = [
    {
        id: 1,
        question: "Her intentions were __________ by her colleagues as selfish motives, causing unnecessary tension in the team.",
        chinese_question: "她的意图被同事们 __________ 为自私的动机，导致了团队中不必要的紧张。",
        answers: [
    ...
    {
        id: 2,
        question: "During the festival, people would __________ in the streets, celebrating joyfully with singing and dancing.",
        chinese_question: "在节日期间，人们会在街上 __________ ，愉快地庆祝，并且唱歌跳舞。",
        answers: [
    ...
    {
        id: 3,
        question: "The politician's opponents tried to __________ his reputation with false accusations that painted him as corrupt and dishonest.",
        chinese_question: "政敌们试图通过虚假指控来 __________ 他的声誉，这些指控把他描绘成腐败和不诚实的人。",
        answers: [
    ...
    {
        id: 4,
        question: "The sandpaper was used to __________ the rough edges of the wooden table, smoothing them down to a fine finish.",
        chinese_question: "砂纸被用来 __________ 木桌的粗糙边缘，将它们打磨得光滑。",
        answers: [
    ...
    {
        id: 5,
        question: "She had the ability to __________ important information quickly, unlike her colleague who forgets or overlooks details, making her a valuable asset in any profession.",
        chinese_question: "她有能力快速 __________ 重要信息，不像她的同事那样忘记或忽视细节，这使她在任何职业中都是一项宝贵的资产。",
        answers: [
    ...
    {
        id: 6,
        question: "The eerie music in the horror movie seemed to __________ a terrifying scene, indicating that something dreadful was about to happen.",
        chinese_question: "恐怖电影中诡异的音乐似乎 __________ 一个恐怖的场景，预示着可怕的事情即将发生。",
        answers: [
    ...
    {
        id: 7,
        question: "The bureaucratic red tape began to __________ the entrepreneurs trying to start new businesses, because it created unnecessary delays and frustrations.",
        chinese_question: "官僚主义的繁文缛节开始让试图创业的企业家们感到 __________，因为它造成了不必要的延误和挫折。",
        answers: [
