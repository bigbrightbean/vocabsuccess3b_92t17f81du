...
var questions = [
    ...
    {
        id: 2,
        question: "The new policy seeks to __________ the responsibilities of each department clearly so that there is no overlap and everyone knows their specific duties.",
        chinese_question: "新政策旨在明确 __________ 每个部门的职责，以便没有重叠，每个人都知道自己的具体职责。",
        answers: [
    ...
    {
        id: 3,
        question: "His family feared that the community would see him as a __________ who is senile and confused due to his occasional forgetfulness.",
    ...
    {
        id: 5,
        question: "The ancient ritual required the priest to __________ a lamb by sacrificing it and burning it as an offering to the gods.",
        chinese_question: "古老的仪式要求祭司通过牺牲并焚烧一只羔羊作为对神的祭品。",
        answers: [
    ...
    {
        id: 6,
        question: "The constant stress at work began to __________ his spirit, leaving him feeling drained and unmotivated to pursue his goals and hobbies.",
        chinese_question: "工作中的持续压力开始 __________ 他的精神，让他感到疲惫和没有动力去追求他的目标和爱好。",
        answers: [
    ...
    {
        id: 7,
        question: "She decided to __________ the old traditions and create her own path in life by challenging societal norms and pursuing her passions.",
        chinese_question: "她决定 __________ 旧传统，开创自己的人生道路，通过挑战社会规范和追求她的激情。",
        answers: [
    ...
    {
        id: 9,
        question: "The counselor asked gentle questions to __________ the student's feelings about the new school, helping her open up.",
        chinese_question: "辅导员通过温和的提问来 __________ 学生对新学校的感受，帮助她敞开心扉。",
        answers: [
            { option: "A", answer: "suppress", chinese_answer: "压制", chinese_romanization: "yā zhì" },
            { option: "B", answer: "conceal", chinese_answer: "隐藏", chinese_romanization: "yǐn cáng" },
            { option: "C", answer: "stifle", chinese_answer: "扼杀", chinese_romanization: "è shā" },
            { option: "D", answer: "elicit", chinese_answer: "引出", chinese_romanization: "yǐn chū" }
        ],
        correctAnswer: "D",
        explanation: "(D) 'elicit' means to draw out or bring forth." +
            "<br><br>" +
            "(A) 'suppress' means to hold back or keep something from happening." +
            "<br><br>" +
            "(B) 'conceal' means to hide something." +
            "<br><br>" +
            "(C) 'stifle' means to stop something from developing.",
        chinese_explanation: "(D) '引出' 意味着引出或带出某事。" +
            "<br><br>" +
            "(A) '压制' 意味着抑制或阻止某事发生。" +
            "<br><br>" +
            "(B) '隐藏' 意味着隐藏某事。" +
    ...
    {
        id: 10,
        question: "Instead of gaining their loyalty, the dictator used fear to __________ the population into obedience.",
