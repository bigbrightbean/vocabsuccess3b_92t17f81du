...
chinese_explanation: "(C) '激励' 意味着让某人有做某事的冲动或能力，特别是做一些创造性的事情。" +
    ...
    {
        id: 2,
        question: "The politician decided to __________ a new environmental policy, advocating for sustainable practices.",
        chinese_question: "这位政治家决定 __________ 一项新的环境政策，倡导可持续做法。",
        answers: [
...
chinese_explanation: "(B) '抨击' 在比喻意义上指以强烈的敌意谈论或写作某事。" +
    ...
    {
        id: 8,
question: "The company __________ its marketing strategy to better appeal to its target audience.",
chinese_question: "公司 __________ 了其营销策略，以更好地吸引目标受众。",
answers: [
...
chinese_explanation: "(B) '改进' 在比喻意义上指改进或完善计划或策略。" +
    ...
    {
        id: 10,
  question: "Her tendency to __________ her children's efforts often left them feeling discouraged.",
  chinese_question: "她 __________ 孩子们努力的倾向常常让他们感到气馁。",
  answers: [
