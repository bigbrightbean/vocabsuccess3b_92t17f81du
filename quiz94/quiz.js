...
var questions = [
    {
        ...
        answers: [
            { option: "A", answer: "confessing", chinese_answer: "坦白的", chinese_romanization: "tǎnbái de" },
            { option: "B", answer: "revealing", chinese_answer: "揭露的", chinese_romanization: "jiēlù de" },
            { option: "C", answer: "disclosing", chinese_answer: "透露的", chinese_romanization: "tòulù de" },
        ...
        explanation: "(D) 'bluffing' means trying to deceive someone as to one's abilities or intentions." +
            "<br><br>" +
            "(A) 'confessing' means admitting to a crime or wrongdoing." +
            "<br><br>" +
            "(B) 'revealing' means making known something that was previously secret or unknown." +
            "<br><br>" +
            "(C) 'disclosing' means making a secret or new information known.",
        chinese_explanation: "(D) '虚张声势的' 意味着试图欺骗某人关于自己的能力或意图。" +
            "<br><br>" +
            "(A) '坦白的' 意味着承认罪行或错误。" +
            "<br><br>" +
            "(B) '揭露的' 意味着公开以前秘密或未知的事情。" +
            "<br><br>" +
            "(C) '透露的' 意味着公开一个秘密或新信息。"
    },
    {
        id: 2,
        question: "The blacksmith decided to __________ the metal to increase its strength by heating it to a high temperature and then slowly cooling it down.",
        chinese_question: "铁匠决定 __________ 金属以增加其强度，通过将其加热到高温然后慢慢冷却。",
        answers: [
...
chinese_explanation: "(A) '遵守' 意味着符合或遵守，这里是比喻用法。" +
    ...
    {
        id: 5,
        question: "She couldn't help but __________ about the long wait at the doctor's office, by repeatedly mentioning the inconvenience and expressing her frustration.",
        chinese_question: "她忍不住 __________ 医生诊所的长时间等待，通过反复提及不便和表达她的沮丧。",
        answers: [
    ...
    {
        id: 8,
        question: "The editor decided to __________ the novel to make it suitable for younger readers by removing inappropriate language and scenes of violence.",
        chinese_question: "编辑决定 __________ 这本小说，通过删除不适当的语言和暴力场景，使其适合年轻读者阅读。",
        answers: [
    ...
    {
        id: 10,
        question: "He chose to __________ his love for her in front of all their friends and family by giving a heartfelt speech and presenting her with a ring.",
        chinese_question: "他选择在所有朋友和家人面前 __________ 对她的爱，通过发表真诚的演讲和赠送她一枚戒指。",
        answers: [
