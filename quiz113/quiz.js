...
var questions = [
    {
        id: 1,
    question: "Unlike his colleagues, he refused to __________ in front of the powerful tycoon and beg for favor because he valued his dignity and self-respect.",
    chinese_question: "与他的同事不同，他拒绝在权贵面前 __________ 并乞求恩惠，因为他重视自己的尊严和自尊。",
    answers: [
    ...
    {
        id: 2,
        question: "She worked hard to __________ any doubts about her abilities from her mind that hindered her confidence and performance, making sure that she only focused on her strengths and achievements.",
        chinese_question: "她努力将对自己能力的任何怀疑 __________ 出脑海，确保只专注于自己的长处和成就。",
        answers: [
    ...
    {
        id: 3,
    question: "In pursuit of success, he decided to __________ all distractions by turning off his phone, setting clear priorities, and dedicating specific time for focused work.",
    chinese_question: "为了追求成功，他决定通过关闭手机、设定明确的优先事项和专门安排集中工作时间来 __________ 所有干扰。",
    answers: [
    ...
    {
        id: 4,
        question: "After a long hike, they sat down to __________ on the picnic they had brought, devouring the sandwiches and snacks eagerly without any hesitation.",
        chinese_question: "长途徒步旅行后，他们坐下来 __________ 带来的野餐，急切地吃着三明治和小吃，没有任何犹豫。",
        answers: [
    ...
    {
        id: 5,
        question: "Her frankness in discussing sensitive topics tends to __________ those around her and make them feel uncomfortable and anxious.",
        chinese_question: "她坦率地讨论敏感话题的方式往往让周围的人感到 __________，并使他们感到不安和焦虑。",
        answers: [
    ...
    {
        id: 6,
        question: "She felt __________ by the expectations of her family, unable to pursue her own dreams and live her life authentically.",
        chinese_question: "她感到被家人的期望所 __________，无法追求自己的梦想和真实地生活。",
        answers: [
    ...
    {
        id: 8,
      question: "All documents __________ to the case, like emails, contracts, and witness statements, were submitted to the court because they provided crucial evidence and supported the arguments.",
      chinese_question: "所有与案件相关的文件，如电子邮件、合同和证人陈述，都提交给了法庭，因为它们提供了关键证据并支持了论点。",
      answers: [
    ...
    {
        id: 9,
    question: "The customer would often __________ the quality of the products by expressing his dissatisfaction and pointing out every flaw he could find.",
    chinese_question: "顾客经常通过表达他的不满并指出他能发现的每一个缺陷来 __________ 产品的质量。",
    answers: [
        ...
        { option: "D", answer: "deprecate", chinese_answer: "贬低", chinese_romanization: "biǎndī" }
    ],
    correctAnswer: "D",
    explanation: "(D) 'deprecate' means to express disapproval of something." +
        "<br><br>" +
        "(A) 'endorse' means to support or approve something." +
        "<br><br>" +
        "(B) 'praise' means to express approval or admiration." +
        "<br><br>" +
        "(C) 'approve' means to agree with or accept something.",
    chinese_explanation: "(D) '贬低' 意味着对某事表示不赞成。" +
        "<br><br>" +
        "(A) '认可' 意味着支持或批准某事。" +
        "<br><br>" +
        "(B) '赞扬' 意味着表示赞同或钦佩。" +
    ...
    {
        id: 10,
        question: "During the trial, the witness was asked to __________ the truth of his statement by providing evidence and testifying under oath to support his claims and establish his credibility.",
        chinese_question: "在审判期间，证人被要求通过提供证据和宣誓作证来 __________ 他陈述的真实性，以支持他的说法并建立他的信誉。",
        answers: [
