...
var questions = [
    {
        id: 1,
        question: "Her __________ attitude towards the rules got her into trouble often.",
        chinese_question: "她对规则的__________态度经常让她陷入麻烦。",
        answers: [
    ...
    {
        id: 9,
        question: "His __________ decision-making skills made him an excellent leader.",
        chinese_question: "他 __________ 的决策能力使他成为一名优秀的领导者。",
        answers: [
    ...
    {
        id: 10,
    question: "The new technology made it __________ to complete the project ahead of schedule.",
    chinese_question: "新技术使提前完成项目成为__________的。",
    answers: [
