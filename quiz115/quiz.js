...
var questions = [
    {
        id: 1,
        question: "The scientist __________ that the results of the experiment were conclusive.",
        chinese_question: "科学家 __________ 实验结果是确凿的。",
        answers: [
    ...
    {
        id: 2,
        question: "The artist felt __________ by the need to conform to commercial expectations, stifling his creativity.",
        chinese_question: "艺术家感到被需要迎合商业期望所 __________，扼杀了他的创造力。",
        answers: [
...
chinese_explanation: "(C) '躲避' 意味着避开某事，通常是巧妙或狡猾的方式。" +
    ...
    {
        id: 8,
question: "The activists __________ with the government to take immediate action on climate change.",
chinese_question: "活动家 __________ 政府立即采取行动应对气候变化。",
answers: [
...
chinese_explanation: "(B) '请求' 意味着提出情感上的请求。" +
    ...
    {
        id: 9,
        question: "Facing overwhelming odds, the general had no choice but to __________ and avoid further casualties.",
        chinese_question: "面对压倒性的困难，将军别无选择，只能 __________ 以避免进一步的伤亡。",
        answers: [
    ...
    {
        id: 10,
        question: "The professor aimed to __________ the principles of mathematics for his students, making them easy to understand.",
        chinese_question: "教授旨在为学生 __________ 数学原理，使其易于理解。",
        answers: [
