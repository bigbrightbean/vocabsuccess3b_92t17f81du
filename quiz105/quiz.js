...
var questions = [
    ...
    {
        id: 4,
        question: "The young entrepreneur was determined not to let anyone __________ him in his business dealings, so he carefully reviewed every contract and sought legal advice.",
        chinese_question: "这位年轻的企业家决心不让任何人在他的业务交易中 __________ 他，因此他仔细审查每一份合同并寻求法律建议。",
        answers: [
    ...
    {
        id: 5,
        question: "The nervous speaker was __________ by a few disruptive attendees who shouted and interrupted him frequently.",
        chinese_question: "这位紧张的演讲者被一些捣乱的听众 __________ ，他们大喊大叫并频繁打断他。",
        answers: [
    ...
    {
        id: 6,
        question: "The scientist decided to __________ the mysterious substance by testing and analyzing it to understand its composition.",
        chinese_question: "科学家决定通过测试和分析这个神秘的物质来 __________ 它，以了解它的成分。",
        answers: [
            { option: "A", answer: "overlook", chinese_answer: "忽略", chinese_romanization: "hū lüè" },
            { option: "B", answer: "disregard", chinese_answer: "漠视", chinese_romanization: "mò shì" },
            { option: "C", answer: "misinterpret", chinese_answer: "误解", chinese_romanization: "wù jiě" },
            { option: "D", answer: "assay", chinese_answer: "化验", chinese_romanization: "huà yàn" }
        ],
        correctAnswer: "D",
        explanation: "(D) 'assay' means to test or analyze something to determine its components." +
            "<br><br>" +
            "(A) 'overlook' means to fail to notice something." +
            "<br><br>" +
            "(B) 'disregard' means to pay no attention to something." +
            "<br><br>" +
            "(C) 'misinterpret' means to understand something incorrectly.",
        chinese_explanation: "(D) '化验' 意味着测试或分析某物以确定其成分。" +
            "<br><br>" +
            "(A) '忽略' 意味着没有注意到某事。" +
            "<br><br>" +
            "(B) '漠视' 意味着不注意某事。" +
    ...
    {
        id: 8,
    question: "When asked to make a decision on where to go for vacation, he __________, suggesting they think about it a bit more instead of choosing right away.",
    chinese_question: "当被问到去哪里度假时，他__________，建议他们再考虑一下，而不是立即做出选择。",
    answers: [
        { option: "A", answer: "decided", chinese_answer: "决定", chinese_romanization: "juédìng" },
        { option: "B", answer: "acted", chinese_answer: "行动", chinese_romanization: "xíngdòng" },
        { option: "C", answer: "chose", chinese_answer: "选择", chinese_romanization: "xuǎnzé" },
        { option: "D", answer: "temporized", chinese_answer: "拖延", chinese_romanization: "tuōyán" }
    ],
    correctAnswer: "D",
    explanation: "(D) 'temporized' means to delay making a decision or to avoid giving a definite answer to gain more time." +
        "<br><br>" +
        "(A) 'decided' means to make a choice." +
        "<br><br>" +
        "(B) 'acted' means to do something." +
        "<br><br>" +
        "(C) 'chose' means to pick something from different options.",
    chinese_explanation: "(D) '拖延' 的意思是推迟做决定或避免给出明确的答案，以争取更多时间。" +
        "<br><br>" +
        "(A) '决定' 的意思是做出选择。" +
        "<br><br>" +
        "(B) '行动' 的意思是做某事。" +
