...
var questions = [
    {
        id: 1,
        question: "The weather was __________, allowing the outdoor event to proceed without any disruptions.",
        chinese_question: "天气很__________，让户外活动顺利进行，没有任何干扰。",
        answers: [
    ...
    {
        id: 2,
        question: "He had only a __________ hope of winning the lottery, but he bought a ticket anyway.",
        chinese_question: "他对赢得彩票的希望很 __________，但还是买了一张票。",
        answers: [
    ...
    {
        id: 5,
        question: "Her explanation was so __________ that it left no room for questions or doubts.",
        chinese_question: "她的解释非常__________，没有留下任何问题或疑问的余地。",
        answers: [
    ...
    {
        id: 6,
        question: "The __________ corruption within the government has led to widespread distrust among the citizens.",
        chinese_question: "政府内 __________ 的腐败导致了公民广泛的不信任。",
        answers: [
    ...
    {
        id: 7,
        question: "Their relationship was __________, full of mutual respect and understanding.",
        chinese_question: "他们的关系非常__________，充满了相互尊重和理解。",
        answers: [
    ...
    {
        id: 10,
    question: "His __________ efforts to improve the community earned him great respect from his neighbors.",
    chinese_question: "他 __________ 的努力改善社区，赢得了邻居们的尊敬。",
    answers: [
