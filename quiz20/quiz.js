...
var questions = [
    {
        id: 1,
        question: "Previously unnoticed, his __________ potential as a leader emerged during the crisis.",
        chinese_question: "以前未被注意到的，他作为领导者的__________潜力在危机期间显现出来。",
        answers: [
    ...
    {
        id: 2,
        question: "She had __________ opportunities to advance her career in the growing company, like participating in leadership programs and taking on challenging projects.",
        chinese_question: "在这家不断发展的公司里，她有 __________ 的机会提升自己的职业生涯，比如参加领导力项目和承担具有挑战性的项目。",
        answers: [
    ...
    {
        id: 3,
    question: "The small town's __________ attitude of resisting change and clinging to tradition made it difficult for new ideas to take root.",
    chinese_question: "这个小镇抵制变化和固守传统的 __________ 态度使得新思想难以扎根。",
    answers: [
    ...
    {
        id: 5,
        question: "His __________ interest in politics, shown by his constant reading of political news and lively discussions, made him a passionate debater.",
        chinese_question: "他对政治的 __________ 兴趣，通过他不断阅读政治新闻和生动的讨论，使他成为一个充满热情的辩论者。",
        answers: [
    ...
    {
        id: 6,
        question: "The poor artist grew up in an __________ environment where resources were scarce and opportunities limited, but his creativity knew no bounds.",
        chinese_question: "这位贫穷的艺术家在一个资源匮乏、机会有限的 __________ 环境中长大，但他的创造力无穷无尽。",
        answers: [
    ...
    {
        id: 7,
        question: "Even when others doubted and challenged her, she remained __________ to her principles, never compromising on her beliefs.",
        chinese_question: "即使在他人怀疑和挑战她的时候，她对自己的原则仍然非常 __________，从不在信仰上妥协。",
        answers: [
    ...
    {
        id: 8,
        question: "It was __________ of her to plan for potential risks like budget overruns and timeline delays before embarking on the project.",
        chinese_question: "她在开始项目之前计划潜在风险，比如预算超支和时间表延误，是__________的。",
        answers: [
    ...
    {
        id: 10,
        question: "With a knack for critical thinking and a talent for innovation, his __________ ability to solve complex problems made him an invaluable member of the research team and a leader in his field.",
        chinese_question: "凭借批判性思维的天赋和创新的才能，他解决复杂问题的 __________ 能力使他成为研究团队中无价的成员，并成为他所在领域的领军人物。",
        answers: [
