...
var questions = [
    {
        id: 1,
        question: "The manager made a __________ for additional funding to complete the project.",
        chinese_question: "经理 __________ 追加资金以完成项目。",
        answers: [
        ...
        explanation: "(A) 'request' means an act of asking politely or formally for something." +
                ...
                "<br><br>" +
                "(D) 'refusal' means an act of denying or rejecting something offered or requested.",
    ...
    },
    {
        ...
        answers: [
            ...
            { option: "B", answer: "facade", chinese_answer: "假象", chinese_romanization: "jiǎxiàng" },
        ...
        explanation: "(D) 'veneer' means an outward appearance that hides the true nature of something." +
            ...
            "<br><br>" +
            "(B) 'facade' means an outward appearance that is maintained to conceal a less pleasant or creditable reality." +
            "<br><br>" +
