...
var questions = [
    {
        id: 1,
        question: "The new manager’s __________ address set a hopeful tone for the company’s future.",
        chinese_question: "新经理的__________演讲为公司的未来定下了希望的基调。",
        answers: [
    ...
    {
        id: 3,
        question: "The CEO had an __________ presence in the company, making all major decisions unchallenged.",
        chinese_question: "这位首席执行官在公司内拥有__________的存在，做出所有重大决定时没有人挑战。",
        answers: [
    ...
    {
        id: 6,
        question: "His __________ habits were a constant source of frustration for his roommates.",
        chinese_question: "他的__________习惯是室友们不断的烦恼来源。",
        answers: [
    ...
    {
        id: 10,
        question: "Despite numerous setbacks and challenges, her __________ determination to succeed never wavered, driving her to achieve her goals.",
        chinese_question: "尽管有许多挫折和挑战，她 __________ 的成功决心从未动摇，推动她实现了目标。",
        answers: [
        ...
        chinese_explanation: "(A) '坚持不懈的' 意味着在困难或反对面前坚定不移地继续行动的。" +
            ...
            "(B) '短暂的' 意味着持续时间非常短的。" +
            "<br><br>" +
            "(C) '零星的' 意味着在不规则间隔发生或仅在少数地方发生的；分散的或孤立的。" +
            "<br><br>" +
            "(D) '偶尔的' 意味着不频繁和不规律地发生、出现或完成的。"
    }
];
