...
var questions = [
    {
        id: 1,
        question: "The benefits of the new policy became __________ over time as employees' productivity increased and morale improved.",
        chinese_question: "随着员工生产力的提高和士气的改善，新政策的好处逐渐变得 __________。",
        answers: [
    ...
    {
        id: 6,
        question: "Being in its __________ stage, the young startup is working on developing its first product and securing initial funding.",
        chinese_question: "处于 __________ 阶段，这家年轻的初创公司正在开发其第一款产品并争取初步资金。",
        answers: [
    ...
    {
        id: 7,
        question: "Her __________ ideas shaped the future direction of the company by introducing groundbreaking concepts and driving strategic decisions.",
        chinese_question: "她的 __________ 想法通过引入突破性概念和推动战略决策决定了公司的未来方向。",
        answers: [
    ...
    {
        id: 9,
        question: "The internet has become a __________ place for exchanging ideas and information, with numerous forums and platforms for discussion.",
        chinese_question: "互联网已成为一个 __________ 的地方，用于交流思想和信息，有无数的论坛和讨论平台。",
        answers: [
