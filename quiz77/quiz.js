...
var questions = [
    ...
    {
        id: 3,
        question: "The exhibit showcased artifacts from the __________ and the future of technology.",
        chinese_question: "展览展示了来自 __________ 和未来科技的文物。",
        answers: [
            { option: "A", answer: "present", chinese_answer: "现在", chinese_romanization: "xiànzài" },
            { option: "B", answer: "immediate", chinese_answer: "立即", chinese_romanization: "lìjí" },
            { option: "C", answer: "contemporary", chinese_answer: "当代", chinese_romanization: "dāngdài" },
            { option: "D", answer: "tentative", chinese_answer: "暂时", chinese_romanization: "zànshí" }
        ],
        correctAnswer: "A",
        explanation: "(A) 'present' means existing or occurring now." +
                "<br><br>" +
                "(B) 'immediate' means occurring or done at once; instant." +
                "<br><br>" +
    ...
    {
        id: 7,
        question: "The __________ for additional security measures was discussed during the meeting.",
        chinese_question: "会议期间讨论了对额外安全措施的 __________。",
        answers: [
            ...
            { option: "C", answer: "refusal", chinese_answer: "拒绝", chinese_romanization: "jùjué" },
        ...
        explanation: "(A) 'request' means an act of asking politely or formally for something." +
                ...
                "<br><br>" +
                "(C) 'refusal' means an act of denying or rejecting something offered or requested." +
                "<br><br>" +
