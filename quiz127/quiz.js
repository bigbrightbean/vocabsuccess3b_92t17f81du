...
var questions = [
    ...
    {
        id: 2,
        question: "The elegant design of the building __________ the architect’s attention to detail, showcasing his meticulous planning and thoughtful execution.",
        chinese_question: "这座建筑的优雅设计 __________ 了建筑师对细节的关注，展示了他细致的规划和周到的执行。",
        answers: [
  ...
  chinese_explanation: "(A) '清楚地表达'一词意味着流利而连贯地表达一个想法或感觉。" +
    ...
    {
        id: 7,
        question: "The company’s policy is to __________ any form of harassment among employees, by strictly enforcing rules and taking immediate action against offenders.",
        chinese_question: "公司的政策是 __________ 员工之间的任何形式的骚扰，通过严格执行规定并对违法者采取立即行动。",
        answers: [
    ...
    {
        id: 9,
        question: "The scam artist __________ the elderly couple out of their life savings, by deceiving them with a fraudulent investment scheme.",
        chinese_question: "骗子通过欺诈性投资计划 __________ 了这对老年夫妇的毕生积蓄。",
        answers: [
