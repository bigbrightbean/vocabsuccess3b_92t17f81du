...
var questions = [
    ...
    {
        id: 8,
    question: "In the artist's studio, her creative space was __________; no one was allowed to rearrange her supplies or touch her unfinished work without her permission.",
    chinese_question: "在艺术家的工作室里，她的创作空间是 __________ 的，没有她的允许，任何人都不准重新摆放她的材料或触碰她未完成的作品。",
    answers: [
        { option: "A", answer: "profaned", chinese_answer: "被亵渎的", chinese_romanization: "bèi xièdú de" },
        { option: "B", answer: "secular", chinese_answer: "世俗的", chinese_romanization: "shìsú de" },
        { option: "C", answer: "desecrated", chinese_answer: "被玷污的", chinese_romanization: "bèi diànwū de" },
    ...
    explanation: "(D) 'sacrosanct' means regarded as too important or valuable to be interfered with." +
        "<br><br>" +
        "(A) 'profaned' means treated with disrespect or irreverence." +
        "<br><br>" +
        "(B) 'secular' means not connected with religious or spiritual matters." +
        "<br><br>" +
        "(C) 'desecrated' means treated with violent disrespect; violated.",
    chinese_explanation: "(D) '神圣不可侵犯的' 意思是被认为太重要或有价值而不能受到干涉。" +
        ...
        "(B) '世俗的' 意思是与宗教或精神事务无关。" +
        "<br><br>" +
        "(C) '被玷污的' 意思是被暴力不敬对待的；被亵渎的。"
    },
    {
        id: 9,
        question: "The director's latest horror film was criticized for its __________ scenes, depicting brutal battles and a high body count.",
        chinese_question: "这位导演的最新恐怖片因其 __________ 的场面而受到批评，描绘了残酷的战斗和大量的死亡。",
        answers: [
            { option: "A", answer: "pacific", chinese_answer: "和平的", chinese_romanization: "hépíng de" },
            { option: "B", answer: "innocuous", chinese_answer: "无害的", chinese_romanization: "wúhài de" },
        ...
        explanation: "(D) 'sanguinary' means involving or causing much bloodshed." +
            "<br><br>" +
            "(A) 'pacific' means peaceful in character or intent." +
            "<br><br>" +
            "(B) 'innocuous' means not harmful or offensive." +
            "<br><br>" +
            "(C) 'benevolent' means well-meaning and kindly.",
        chinese_explanation: "(D) '血腥的' 意思是涉及或造成大量流血。" +
            "<br><br>" +
            "(A) '和平的' 意思是性格或意图上和平的。" +
            "<br><br>" +
            "(B) '无害的' 意思是无害或无攻击性的。" +
