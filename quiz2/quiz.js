...
var questions = [
    {
        id: 1,
        question: "Her comments were not __________ for the serious nature of the meeting, which required a more formal and respectful tone.",
        chinese_question: "她的评论对会议的严肃性质来说并不 __________，会议需要更正式和尊重的语气。",
        answers: [
    ...
    {
        id: 3,
        question: "The young __________ business showed great promise, attracting many investors to its innovative and rapidly growing operations.",
        chinese_question: "这家 __________ 的企业显示出巨大的潜力，吸引了许多投资者前来投资其创新且快速增长的业务。",
        answers: [
    ...
    answers: [
        ...
        { option: "B", answer: "unfavorable", chinese_answer: "不利的", chinese_romanization: "bù lì de" },
        { option: "C", answer: "viable", chinese_answer: "可行的", chinese_romanization: "kěxíng de" },
        { option: "D", answer: "intolerable", chinese_answer: "不可忍受的", chinese_romanization: "bùkě rěnshòu de" }
    ],
    correctAnswer: "C",
    explanation: "(C) 'viable' means capable of working successfully." +
        "<br><br>" +
        "(A) 'implausible' means not seeming reasonable or probable." +
        "<br><br>" +
        "(B) 'unfavorable' means expressing or showing a lack of approval or support." +
        "<br><br>" +
        "(D) 'intolerable' means unable to be endured.",
    chinese_explanation: "(C) '可行的' 意味着能够成功地运作。" +
        "<br><br>" +
        "(A) '不可信的' 意味着看起来不合理或不可能的。" +
        "<br><br>" +
        "(B) '不利的' 意味着表达或显示不赞成或不支持。" +
        "<br><br>" +
        "(D) '不可忍受的' 意味着不能忍受的。"
    },
    {
