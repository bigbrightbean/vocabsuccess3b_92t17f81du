...
var questions = [
    ...
    {
        id: 3,
        question: "The lawyer was __________ to the client's secrets, ensuring that their discussions remained confidential.",
        chinese_question: "律师 __________ 知道客户的秘密，确保他们的讨论保持机密。",
        answers: [
    ...
    {
        id: 10,
        question: "His __________ idea for a new app quickly attracted investors.",
        chinese_question: "他对新应用的 __________ 想法迅速吸引了投资者。",
        answers: [
