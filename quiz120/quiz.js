...
chinese_explanation: "(B) '抨击' 意味着对某事物进行强烈的批评。" +
    ...
    {
        id: 7,
question: "The leader's speech managed to __________ the crowd into taking immediate action.",
chinese_question: "领导者的演讲设法 __________ 群众立即采取行动。",
answers: [
...
chinese_explanation: "(B) '激励' 意味着激励或激发某人采取行动。" +
    ...
    {
        id: 8,
        question: "Some fans __________ their favorite celebrities, treating them as more than just human.",
    ...
    {
        id: 9,
        question: "The manager's tendency to __________ minor issues often leads to unnecessary delays.",
        chinese_question: "经理对小问题的 __________ 往往导致不必要的延误。",
        answers: [
    ...
    {
        id: 10,
question: "After the meeting, the members began to __________ to their respective departments.",
