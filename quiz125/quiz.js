...
var questions = [
    {
        id: 1,
        question: "In order to keep the peace, he chose to __________ by accepting the situation reluctantly without protest, rather than argue further.",
        chinese_question: "为了保持和平，他选择 __________，通过不情愿地接受这种情况而没有抗议，而不是进一步争论。",
        answers: [
...
chinese_explanation: "(A) '达到顶峰' 意味着达到最高点。" +
    ...
    {
        id: 4,
        question: "As they worked on the project, their ideas began to __________ into a coherent plan, and they could see their vision taking shape.",
        chinese_question: "当他们进行项目时，他们的想法开始 __________ 成为一个连贯的计划，他们可以看到自己的愿景成形。",
        answers: [
    ...
    {
        id: 5,
        question: "The controversial book was accused of trying to __________ the minds of young readers, by filling them with morally corrupt ideas.",
        chinese_question: "这本有争议的书被指试图通过灌输道德败坏的思想来 __________ 年轻读者的思想。",
        answers: [
    ...
    {
        id: 6,
        question: "The report __________ the company for its poor handling of the environmental crisis, by highlighting their negligence and failures.",
        chinese_question: "报告通过强调他们的疏忽和失败来 __________ 该公司对环境危机的处理不当。",
        answers: [
...
chinese_explanation: "(A) '归罪' 意味着指责或归咎于某人，这里是比喻用法。" +
    ...
    {
        id: 9,
        question: "The winemaker carefully __________ the wine to separate it from the sediment, so that the final product would be clear and pure.",
        chinese_question: "酿酒师小心翼翼地 __________ 酒，以便将其与沉淀物分离，从而使最终产品清澈纯净。",
        answers: [
    ...
    {
        id: 10,
        question: "The intense scrutiny did not __________ the candidate, who maintained a calm demeanour throughout the interview.",
