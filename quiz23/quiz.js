...
var questions = [
    {
        id: 1,
    question: "Her __________ advice about career choices, delivered with cryptic statements and a solemn tone, often left people more confused than enlightened.",
    chinese_question: "她关于职业选择的 __________ 建议，以隐晦的陈述和庄重的语气表达，往往让人们更加困惑而不是启发。",
    answers: [
    ...
    correctAnswer: "B",
    explanation: "(B) 'oracular' means giving advice in a mysterious and confusing way, like a fortune teller." +
        "<br><br>" +
    ...
    chinese_explanation: "(B) '神谕般的' 意味着像占卜者一样以神秘和令人困惑的方式给出建议。" +
        "<br><br>" +
    ...
    {
        id: 3,
        question: "His __________ analysis of the market trends, like identifying emerging technologies and predicting consumer behavior shifts, helped the company make informed decisions.",
        chinese_question: "他对市场趋势的 __________ 分析，例如识别新兴技术和预测消费者行为变化，帮助公司做出明智的决定。",
        answers: [
    ...
    {
        id: 4,
        question: "Always maintaining a clean environment and regularly washing his hands, his __________ habits ensured that he rarely fell ill.",
        chinese_question: "总是保持干净的环境并定期洗手，他的 __________ 习惯确保他很少生病。",
        answers: [
    ...
    {
        id: 5,
        question: "As the key member of the team, he feels __________ for the success of the project and puts in extra hours to ensure everything goes smoothly.",
        chinese_question: "作为团队的关键成员，他觉得 __________ 项目的成功，并加班加点确保一切顺利进行。",
        answers: [
    ...
    {
        id: 6,
        question: "It is __________ for the company to hold an annual picnic for its employees every year as a way to boost morale.",
    ...
    {
        id: 7,
        question: "The professor's __________ explanation with clear examples and engaging stories made the complex subject accessible to all students.",
        chinese_question: "教授 __________ 的解释，通过清晰的例子和引人入胜的故事，使复杂的主题对所有学生都易于理解。",
        answers: [
