...
var questions = [
    {
        id: 1,
        question: "With her calm demeanor and kind eyes, her __________ look made it hard to believe she could be involved in the scandal.",
        chinese_question: "她平静的举止和善良的眼神，她的 __________ 表情让人难以相信她会卷入丑闻。",
        answers: [
    ...
    {
        id: 2,
        question: "His __________ thinking allowed him to solve the problem in an innovative way and find a solution that others had overlooked.",
        chinese_question: "他 __________ 的思维方式使他能够以创新的方式解决问题，并找到别人忽略的解决方案。",
        answers: [
    ...
    {
        id: 4,
        question: "The company's __________ approach to budgeting, like cutting unnecessary expenses and prioritizing essential spending, helped it survive during the economic downturn.",
        chinese_question: "公司在预算上的 __________ 方法，比如削减不必要的开支和优先考虑必要的支出，帮助它在经济低迷时期存活下来。",
        answers: [
    ...
    {
        id: 5,
    question: "The manager's __________ criticism, like calling out mistakes in front of everyone and using harsh language, left the employee feeling demoralized and upset.",
    chinese_question: "经理的__________批评，比如在众人面前指出错误和使用严厉的语言，让员工感到士气低落和沮丧。",
    answers: [
    ...
    {
        id: 7,
        question: "Her __________ silence after the argument, marked by avoiding eye contact and refusing to speak, was more telling than any words she could have spoken.",
        chinese_question: "争论后的 __________ 沉默，通过避免眼神接触和拒绝说话，比她可能说出的任何话都更有说服力。",
        answers: [
    ...
    {
        id: 8,
        question: "Her __________ enthusiasm for new projects often faded after a few weeks, and she would quickly lose interest.",
        chinese_question: "她对新项目的 __________ 热情通常在几周后就会消退，她会很快失去兴趣。",
        answers: [
