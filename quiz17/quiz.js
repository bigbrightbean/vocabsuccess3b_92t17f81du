...
var questions = [
    ...
    {
        id: 7,
        question: "The manager's __________ behavior stifled creativity and innovation among the team members.",
        chinese_question: "经理的__________行为扼杀了团队成员的创造力和创新。",
        answers: [
    ...
    {
        id: 9,
        question: "Her confidence made her feel __________ in any challenging situation.",
        chinese_question: "她的自信让她在任何挑战性情况下都感到__________。",
        answers: [
    ...
    {
        id: 10,
    question: "Her __________ efforts to build a strong team paid off in the long run.",
    chinese_question: "她 __________ 地努力建立一个强大的团队，长期来看取得了成功。",
    answers: [
