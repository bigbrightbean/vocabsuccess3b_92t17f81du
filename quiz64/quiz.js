...
var questions = [
    ...
    {
        id: 3,
        question: "The government decided to impose economic __________ on the country, such as trade restrictions and financial penalties, as a response to its aggressive actions.",
        chinese_question: "政府决定对该国实施经济 __________，例如贸易限制和经济处罚，以回应其侵略行为。",
        answers: [
...
chinese_explanation: "(A) '漩涡' 意味着海洋或河流中的强大漩涡，或比喻一种混乱的运动或暴力动荡状态。" +
    ...
    {
        id: 5,
        question: "Her poetry is known for its __________ and emotional depth, delving into complex themes like human existence and mortality, which deeply touch the hearts of many readers.",
        chinese_question: "她的诗歌以其 __________ 和情感深度而著称，深入探讨了人类存在和死亡等复杂主题，深深打动了许多读者的心。",
        answers: [
    ...
    {
        id: 9,
    question: "In the small village, she was known as a __________, often seen courageously leading the community through the most challenging times with unwavering strength and determination.",
    chinese_question: "在这个小村庄里，她被称为 __________，经常被看到勇敢地带领社区度过最艰难的时期，表现出坚定的力量和决心。",
    answers: [
        ...
        { option: "C", answer: "meek", chinese_answer: "温顺的", chinese_romanization: "wēnshùn de" },
        { option: "D", answer: "virago", chinese_answer: "悍妇", chinese_romanization: "hànfù" }
    ],
    correctAnswer: "D",
    explanation: "(D) 'virago' means a strong, brave, or warlike woman." +
        "<br><br>" +
        ...
        "<br><br>" +
        "(C) 'meek' means quiet, gentle, and easily imposed on; submissive.",
    chinese_explanation: "(D) '悍妇' 意味着一个坚强、勇敢或好战的女人。" +
        "<br><br>" +
        "(A) '胆小的' 意味着表现出缺乏勇气或信心；容易受惊。" +
        "<br><br>" +
        "(B) '顺从的' 意味着准备服从他人的权威或意愿；温顺地服从或被动。" +
        "<br><br>" +
        "(C) '温顺的' 意味着安静、温柔和容易被强加的；顺从的。"
    },
    {
        id: 10,
    question: "After the disappointing performance, the coach's feedback was filled with __________, harshly criticizing every mistake the players made on the field.",
    chinese_question: "在令人失望的表现之后，教练的反馈充满了 __________，严厉地批评了球员在场上犯下的每一个错误。",
    answers: [
        ...
        { option: "D", answer: "vituperation", chinese_answer: "谩骂", chinese_romanization: "mànmà" }
    ],
    correctAnswer: "D",
    explanation: "(D) 'vituperation' means bitter and abusive language." +
        "<br><br>" +
        "(A) 'applause' means the clapping of hands to show approval." +
        "<br><br>" +
        "(B) 'accolade' means an award or privilege granted as a special honor or as an acknowledgment of merit." +
        "<br><br>" +
        "(C) 'commendation' means praise formally or officially.",
    chinese_explanation: "(D) '谩骂' 意味着尖刻和辱骂的语言。" +
        "<br><br>" +
        "(A) '掌声' 意味着拍手表示赞同。" +
        "<br><br>" +
        "(B) '荣誉' 意味着作为特别荣誉或表彰功绩而授予的奖项或特权。" +
        "<br><br>" +
        "(C) '表扬' 意味着正式或官方的表扬。"
    }
];
