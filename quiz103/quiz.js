...
var questions = [
    {
        id: 1,
        question: "Even though he tried to apologize, she decided to __________ his flowers and walked away angrily.",
        chinese_question: "尽管他试图道歉，她还是决定 __________ 他的花，然后生气地走开了。",
        answers: [
        ...
        explanation: "(D) 'spurn' means to reject something or someone with disdain." +
            "<br><br>" +
            "(A) 'embrace' means to hold someone closely in your arms." +
            "<br><br>" +
            "(B) 'welcome' means to greet someone warmly." +
            "<br><br>" +
    ...
    {
        id: 2,
        question: "The emergency team had to remove the fallen tree that __________ the road and caused a traffic jam.",
        chinese_question: "应急小组必须移走阻塞道路的倒树，该树引发了交通堵塞。",
        answers: [
    ...
    {
        id: 3,
        question: "The president made it his priority to __________ the new environmental policies by addressing the nation on television and publishing articles, ensuring that all citizens were aware of the changes.",
        chinese_question: "总统通过在电视上向全国发表讲话和发表文章将宣布新的环保政策作为他的首要任务，确保所有公民都了解这些变化。",
        answers: [
    ...
    {
        id: 4,
        question: "The politician was quick to __________ his opponent’s policies during the debate, criticizing them harshly and pointing out their flaws.",
        chinese_question: "在辩论中，这位政治家迅速 __________ 对手的政策，严厉批评并指出其缺陷。",
        answers: [
    ...
    {
        id: 5,
        question: "In preparation for the presentation, he decided to __________ his speaking skills by practicing regularly and seeking feedback.",
        chinese_question: "为了准备演讲，他决定通过定期练习和寻求反馈来 __________ 自己的演讲技巧。",
        answers: [
    ...
    {
        id: 7,
        question: "The architect's design needed to __________ to the city's building codes and not violate any regulations.",
        chinese_question: "建筑师的设计需要 __________ 城市的建筑规范，并且不违反任何规定。",
        answers: [
