...
var questions = [
    {
        id: 1,
        question: "The high school student was given detention for his __________, like texting in class and forgetting his homework.",
        chinese_question: "这名高中生因他的__________被罚留校，比如上课发短信和忘记做作业。",
        answers: [
        ...
        explanation: "(D) 'peccadillo' means a small mistake or bad behavior that is not very serious." +
            ...
            "<br><br>" +
            "(C) 'goodness' means being good and kind.",
        chinese_explanation: "(D) '小过失' 意思是一个不太严重的小错误或不良行为。" +
            "<br><br>" +
            "(A) '美德' 意思是好的品质或行为。" +
            "<br><br>" +
            "(B) '完美' 意思是没有任何错误的完美状态。" +
    ...
    {
        id: 2,
    question: "She found great __________ in helping others and making a difference in their lives, feeling immense satisfaction and joy in their smiles and gratitude.",
    chinese_question: "她在帮助他人和改变他们的生活中找到了巨大的 __________，在他们的微笑和感激中感到极大的满足和快乐。",
        answers: [
    ...
    {
        id: 4,
    question: "His unwavering __________ in all his dealings, such as fair negotiations and honest business practices, made him a highly respected figure in the community.",
    chinese_question: "他在所有事务中的坚定 __________ ，比如公平的谈判和诚实的商业行为，使他成为社区中备受尊敬的人物。",
    answers: [
    ...
    {
        id: 6,
        question: "The __________ of decorations at the party made the small room feel overly crowded because of the numerous balloons and garlands hanging everywhere.",
        chinese_question: "派对上的 __________ 装饰让小房间显得过于拥挤，因为到处挂满了气球和花环。",
        answers: [
    ...
    {
        id: 9,
        question: "The teenage girls rolled their eyes at the __________, like 'follow your dreams' and 'believe in yourself,' because they heard them so many times before.",
        chinese_question: "这些十几岁的女孩对那些__________比如“追随梦想”和“相信自己”翻了翻眼睛，因为她们已经听过太多次了。",
        answers: [
            { option: "A", answer: "wisdom", chinese_answer: "智慧", chinese_romanization: "zhìhuì" },
            { option: "B", answer: "insight", chinese_answer: "见解", chinese_romanization: "jiànjiě" },
            { option: "C", answer: "novelty", chinese_answer: "新奇", chinese_romanization: "xīnqí" },
            { option: "D", answer: "platitude", chinese_answer: "陈词滥调", chinese_romanization: "chéncí làndiào" }
        ],
        correctAnswer: "D",
        explanation: "(D) 'platitude' means a saying that is not interesting or helpful because it has been used too often." +
            "<br><br>" +
            "(A) 'wisdom' means good sense and judgment." +
            "<br><br>" +
            "(B) 'insight' means a deep understanding of a person or thing." +
            "<br><br>" +
            "(C) 'novelty' means the quality of being new, original, or unusual.",
        chinese_explanation: "(D) '陈词滥调' 意思是因为被用得太多而不有趣或没有帮助的说法。" +
            "<br><br>" +
            "(A) '智慧' 意思是好的判断力和判断。" +
            "<br><br>" +
            "(B) '见解' 意思是对一个人或事物的深刻理解。" +
            "<br><br>" +
            "(C) '新奇' 意思是新颖、原创或不寻常的品质。"
    },
    {
        id: 10,
        question: "The choir felt a sense of __________ when their conductor unexpectedly quit, leaving them unsure about their upcoming performance.",
        chinese_question: "当他们的指挥意外辞职时，合唱团感到一种__________，让他们对即将到来的演出感到不确定。",
        answers: [
            { option: "A", answer: "calm", chinese_answer: "平静", chinese_romanization: "píngjìng" },
            { option: "B", answer: "serenity", chinese_answer: "宁静", chinese_romanization: "níngjìng" },
            { option: "C", answer: "peace", chinese_answer: "和平", chinese_romanization: "hépíng" },
            { option: "D", answer: "disquiet", chinese_answer: "不安", chinese_romanization: "bù'ān" }
        ],
        correctAnswer: "D",
        explanation: "(D) 'disquiet' means a feeling of worry or unease." +
            "<br><br>" +
            "(A) 'calm' means a state of being peaceful and quiet." +
            "<br><br>" +
            "(B) 'serenity' means the state of being calm and peaceful." +
            "<br><br>" +
            "(C) 'peace' means a state of no conflict or trouble.",
        chinese_explanation: "(D) '不安' 意思是担心或不安的感觉。" +
            "<br><br>" +
            "(A) '平静' 意思是和平安静的状态。" +
            "<br><br>" +
            "(B) '宁静' 意思是平静和平的状态。" +
