...
var questions = [
    {
        id: 1,
    question: "The gym trainer's voice had a __________ effect during the meditation session, causing some participants to nod off.",
    chinese_question: "健身教练的声音在冥想课程中有一种__________的效果，导致一些参与者打瞌睡。",
    answers: [
        { option: "A", answer: "energizing", chinese_answer: "使人充满活力的", chinese_romanization: "shǐ rén chōngmǎn huólì de" },
        { option: "B", answer: "motivational", chinese_answer: "激励人心的", chinese_romanization: "jīlì rénxīn de" },
    ...
    explanation: "(D) 'soporific' means tending to induce drowsiness or sleep." +
        "<br><br>" +
        "(A) 'energizing' means giving energy or vitality; invigorating." +
        "<br><br>" +
        "(B) 'motivational' means providing encouragement or inspiration." +
        "<br><br>" +
        "(C) 'inspiring' means having the effect of inspiring someone.",
    chinese_explanation: "(D) '催眠的' 意思是使人昏昏欲睡或睡着。" +
        "<br><br>" +
        "(A) '使人充满活力的' 意思是赋予活力或生命力；振奋精神。" +
        "<br><br>" +
        "(B) '激励人心的' 意思是提供鼓励或启发。" +
        "<br><br>" +
        "(C) '鼓舞人心的' 意思是有激发作用的。"
