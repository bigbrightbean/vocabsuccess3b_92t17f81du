...
var questions = [
    ...
    {
        id: 3,
        question: "The politician's speech was criticized for __________ important facts that contradicted his claims, in an attempt to mislead the audience.",
        chinese_question: "政治家的演讲因为 __________ 与他主张相矛盾的重要事实而受到批评，这是为了误导观众。",
        answers: [
    ...
    {
        id: 5,
        question: "She accepted the bribe without __________ or hesitation, focusing solely on the immediate benefit and not the consequences.",
        chinese_question: "她毫无 __________ 或犹豫地接受了贿赂，只关注眼前的利益而不考虑后果。",
        answers: [
    ...
    {
        id: 7,
        question: "The publisher chose to __________ the classic book by removing offensive language and updating outdated references to make it more appropriate for modern audiences.",
        chinese_question: "出版社选择通过删除冒犯性语言和更新过时的参考资料来 __________ 这本经典书籍，使其更适合现代读者。",
        answers: [
    ...
    {
        id: 8,
        question: "The company had to __________ itself from the bad publicity after the scandal by issuing public apologies and implementing new policies so that it could restore its reputation.",
        chinese_question: "公司不得不通过发布公开道歉和实施新政策，从丑闻后的负面宣传中 __________ 自己，以恢复其声誉。",
        answers: [
