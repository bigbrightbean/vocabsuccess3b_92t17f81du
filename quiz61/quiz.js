...
var questions = [
    {
        id: 1,
        question: "Unlike her predecessors who held conservative beliefs, her views on social issues were very __________, reflecting current trends and values.",
        chinese_question: "与持保守信仰的前辈不同，她对社会问题的看法非常__________，反映了当前的趋势和价值观。",
        answers: [
    ...
    {
        id: 2,
        question: "The charity worker was __________, asking every passerby for donations and not taking no for an answer.",
        chinese_question: "这名慈善工作者非常 __________，向每一个过路人请求捐款，并且不接受拒绝。",
        answers: [
    ...
    {
        id: 7,
        question: "The __________ purpose of the meeting, with no other items on the agenda, was to discuss the upcoming project deadline.",
        chinese_question: "会议的 __________ 目的，且没有其他议程项目，是讨论即将到来的项目截止日期。",
        answers: [
    ...
    {
        id: 10,
        question: "The lawyer's __________ questioning of the witnesses, such as probing inconsistencies and highlighting contradictions, revealed the truth that had been hidden for years.",
        chinese_question: "律师对证人的__________质问，例如探究不一致之处和强调矛盾之处，揭示了隐藏多年的真相。",
        answers: [
