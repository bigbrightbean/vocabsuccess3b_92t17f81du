...
var questions = [
    {
        id: 1,
        question: "The constant demands of the job began to __________ on his personal time until he found himself working late nights and missing family dinners.",
        chinese_question: "工作的不断要求开始__________他的个人时间，直到他发现自己要工作到深夜并错过家庭晚餐。",
        answers: [
...
chinese_explanation: "(B) '强加' 意味着以一种不受欢迎或侵扰的方式把某事，尤其是意见，强加给别人。" +
    ...
    {
        id: 3,
        question: "The company had to __________ its decision after realizing it was unpopular, reverting to the original plan instead.",
        chinese_question: "公司在意识到该决定不受欢迎后不得不__________决定，改回原计划。",
        answers: [
    ...
    {
        id: 4,
    question: "The boy was punished for __________ the school's rules, such as skipping classes, cheating on exams, and vandalizing property.",
    chinese_question: "那个男孩因 __________ 学校的规定而受到惩罚，例如逃课、考试作弊和破坏财物。",
    answers: [
        { option: "A", answer: "obeying", chinese_answer: "遵守", chinese_romanization: "zūnshǒu" },
        { option: "B", answer: "upholding", chinese_answer: "维护", chinese_romanization: "wéihù" },
        { option: "C", answer: "respecting", chinese_answer: "尊重", chinese_romanization: "zūnzhòng" },
        { option: "D", answer: "transgressing", chinese_answer: "违反", chinese_romanization: "wéifǎn" }
    ],
    correctAnswer: "D",
    explanation: "(D) 'transgressing' means to violate a law or moral code." +
        "<br><br>" +
        "(A) 'obeying' means to follow the commands or guidance of." +
        "<br><br>" +
        "(B) 'upholding' means to support or maintain." +
        "<br><br>" +
        "(C) 'respecting' means to show regard or consideration for.",
    chinese_explanation: "(D) '违反' 意味着违反法律或道德准则。" +
        "<br><br>" +
        "(A) '遵守' 意味着遵循命令或指导。" +
        "<br><br>" +
        "(B) '维护' 意味着支持或维护。" +
    ...
    {
        id: 6,
        question: "The borrower’s decision to __________ on the loan, by failing to make the required payments for several months, resulted in legal action by the bank.",
        chinese_question: "借款人决定 __________ 贷款，因为连续几个月未能按时还款，导致银行采取法律行动。",
        answers: [
    ...
    {
        id: 7,
        question: "The long hours of tedious work began to __________ her and caused her to feel exhausted, thereby diminishing her concentration and overall productivity.",
        chinese_question: "漫长而乏味的工作时间开始 __________ 她，使她感到精疲力尽，从而削弱了她的注意力和整体生产力。",
        answers: [
    ...
    {
        id: 8,
    question: "With determination and keen observation, he managed to __________ out the truth despite all the lies.",
    chinese_question: "凭借决心和敏锐的观察力，他还是设法 __________ 出真相，尽管谎言重重。",
    answers: [
    ...
    {
        id: 9,
        question: "Efforts to __________ invasive species in the park, such as systematically removing non-native plants and trapping invasive animals, have been largely successful.",
        chinese_question: "在公园里通过系统地移除非本地植物和捕捉入侵动物来 __________ 外来物种的努力已经取得了很大的成功。",
        answers: [
    ...
    {
        id: 10,
        question: "She found it hard to __________ her disappointment when she didn't get the promotion, despite trying to keep a smile and act as if everything was fine.",
        chinese_question: "当她没有得到升职时，她发现很难 __________ 自己的失望，尽管她努力保持微笑，表现得一切正常。",
        answers: [
