...
var questions = [
    ...
    {
        id: 3,
    question: "Throughout her life, she faced numerous __________, experiencing both great triumphs and devastating losses, yet she remained resilient.",
    chinese_question: "在她的一生中，她经历了无数的 __________，既有巨大的胜利，也有令人心碎的失败，但她仍然保持坚韧。",
    answers: [
        { option: "A", answer: "stabilities", chinese_answer: "稳定", chinese_romanization: "wěndìng" },
        { option: "B", answer: "consistencies", chinese_answer: "一致性", chinese_romanization: "yízhìxìng" },
        { option: "C", answer: "uniformities", chinese_answer: "一致性", chinese_romanization: "yízhìxìng" },
        { option: "D", answer: "vicissitudes", chinese_answer: "变迁", chinese_romanization: "biànqiān" }
    ],
    correctAnswer: "D",
    explanation: "(D) 'vicissitudes' means a change of circumstances or fortune, typically one that is unwelcome or unpleasant." +
        "<br><br>" +
        "(A) 'stabilities' means the quality or state of being stable." +
        "<br><br>" +
        "(B) 'consistencies' means conformity in the application of something, typically that which is necessary for the sake of logic, accuracy, or fairness." +
        "<br><br>" +
        "(C) 'uniformities' means the quality or state of being uniform." +
        "<br><br>" +
        "(D) 'vicissitudes' means a change of circumstances or fortune, typically one that is unwelcome or unpleasant.",
    chinese_explanation: "(D) '变迁' 意味着环境或命运的变化，通常是不受欢迎或令人不快的变化。" +
        "<br><br>" +
        "(A) '稳定' 意味着稳定的质量或状态。" +
        "<br><br>" +
        "(B) '一致性' 意味着在某物的应用上的一致性，通常是为了逻辑、准确性或公平。" +
        "<br><br>" +
        "(C) '一致性' 意味着一致的质量或状态。" +
        "<br><br>" +
        "(D) '变迁' 意味着环境或命运的变化，通常是不受欢迎或令人不快的变化。"
    },
    {
        id: 4,
