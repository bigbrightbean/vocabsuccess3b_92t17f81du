...
var questions = [
    {
        id: 1,
        question: "She felt embarrassed when she realized she had been __________ by a fake news article.",
        chinese_question: "当她意识到自己被一篇假新闻 __________ 时，她感到很尴尬。",
        answers: [
    ...
    {
        id: 2,
        question: "Despite their different paths, the old friends continued to __________ to their shared memories.",
        chinese_question: "尽管各奔前程，这些老朋友依然 __________ 他们共同的记忆。",
        answers: [
    ...
    {
        id: 3,
        question: "In the meeting, she had to __________ a solution when the original plan fell apart.",
        chinese_question: "在会议中，当原计划失败时，她不得不 __________ 一个解决方案。",
        answers: [
    ...
    {
        id: 4,
question: "The rapid changes in technology can __________ even the most tech-savvy individuals.",
chinese_question: "快速的技术变化甚至会让最懂技术的人感到 __________。",
answers: [
...
chinese_explanation: "(A) '归因于' 意味着将某事，特别是过错或不当行为，归咎于某人或某物，这里是比喻用法。" +
    ...
    {
        id: 6,
        question: "His laid-back style didn't __________ with the company's strict dress code.",
        chinese_question: "他的随意风格与公司的严格着装规定不 __________ 。",
        answers: [
