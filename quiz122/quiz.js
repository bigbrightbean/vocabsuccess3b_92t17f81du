...
var questions = [
    {
        id: 1,
        question: "She would often __________ the suggestions of her colleagues, believing she always knew best.",
        chinese_question: "她经常 __________ 她同事的建议，认为她自己总是最了解。",
        answers: [
    ...
    {
        id: 2,
        question: "The team had to __________ some of their initial ideas to streamline the project.",
        chinese_question: "团队必须 __________ 一些最初的想法以简化项目。",
        answers: [
    ...
    {
        id: 3,
        question: "The manager's motivational speech helped to __________ a change in the team's attitude.",
        chinese_question: "经理的鼓舞人心的讲话帮助 __________ 了团队态度的改变。",
        answers: [
    ...
    {
        id: 5,
        question: "The children were happy to __________ themselves in the park on a sunny day.",
        chinese_question: "孩子们在阳光明媚的日子里很高兴在公园里 __________ 自己。",
        answers: [
    ...
    {
        id: 6,
question: "After hours of negotiation, tempers began to __________.",
chinese_question: "经过数小时的谈判，脾气开始 __________。",
answers: [
...
chinese_explanation: "(A) '磨损' 意味着使某人变得紧张或有压力。" +
    ...
    {
        id: 7,
        question: "The contract will __________ the scope of work to be completed by the contractor.",
        chinese_question: "合同将 __________ 承包商需要完成的工作范围。",
        answers: [
