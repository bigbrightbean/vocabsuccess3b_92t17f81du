...
var questions = [
    ...
    {
        id: 2,
        question: "Investing in the stock market carries a certain level of __________.",
        chinese_question: "投资股市带有一定程度的 __________。",
        answers: [
        ...
        explanation: "(B) 'risk' means a situation involving exposure to danger." +
                "<br><br>" +
                "(A) 'certainty' means the state of being sure or confident." +
                "<br><br>" +
    ...
    {
        id: 6,
        question: "The business __________ can be extremely competitive and challenging.",
        chinese_question: "商业 __________ 可能非常竞争和具有挑战性。",
        answers: [
            { option: "A", answer: "hall", chinese_answer: "大厅", chinese_romanization: "dàtīng" },
        ...
        explanation: "(B) 'arena' means a place or scene of activity, debate, or conflict." +
                "<br><br>" +
                "(A) 'hall' means a large room or building for meetings, concerts, or other events." +
                "<br><br>" +
        ...
        chinese_explanation: "(B) '竞技场' 意味着活动、辩论或冲突的场所或场景。" +
                "<br><br>" +
                "(A) '大厅' 意味着用于会议、音乐会或其他活动的大房间或建筑。" +
                "<br><br>" +
                "(C) '房间' 意味着建筑物的一部分或分区，由墙壁、地板和天花板围起来。" +
                "<br><br>" +
                "(D) '舞台' 意味着通常在剧院中的一个抬高的地板或平台，演员、娱乐者或演讲者在其上表演。"
    },
    {
        id: 7,
        question: "The sudden resignation of the CEO threw the company into __________.",
        chinese_question: "CEO 的突然辞职使公司陷入了 __________。",
        answers: [
    ...
    {
        id: 10,
        question: "The ship was stocked with enough __________ to ensure the crew could survive the long voyage.",
        chinese_question: "船上储备了足够的 __________，确保船员能够在漫长的航程中生存。",
        answers: [
