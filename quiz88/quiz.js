...
var questions = [
    ...
    {
        id: 3,
        question: "The company decided to __________ into the new market despite the risks involved.",
        chinese_question: "尽管存在风险，公司决定 __________ 进入新市场。",
        answers: [
            { option: "A", answer: "plunge", chinese_answer: "投入", chinese_romanization: "tóurù" },
            ...
            { option: "D", answer: "ponder", chinese_answer: "思考", chinese_romanization: "sīkǎo" }
        ],
        correctAnswer: "A",
        explanation: "(A) 'plunge' means to begin or engage in something energetically or enthusiastically." +
                "<br><br>" +
                "(B) 'retreat' means to move back or withdraw." +
                "<br><br>" +
        ...
        chinese_explanation: "(A) '投入' 意味着充满活力或热情地开始或参与某事。" +
                "<br><br>" +
                "(B) '撤退' 意味着后退或撤回。" +
                "<br><br>" +
    ...
    {
        id: 8,
        question: "Understanding a complex issue often requires going through a step-by-step __________.",
        chinese_question: "理解复杂问题通常需要经历一个逐步的 __________。",
        answers: [
        ...
        chinese_explanation: "(B) '过程' 意味着为了实现特定目标而采取的一系列行动或步骤。" +
                "<br><br>" +
                "(A) '灾难' 意味着突然的事件，如事故或自然灾害，造成巨大损失或人员伤亡。" +
                "<br><br>" +
                "(C) '事故' 意味着意外且无意中发生的不幸事件。" +
                "<br><br>" +
                "(D) '庆祝' 意味着通过参与愉快的、通常是社交活动来标记对重要事件或场合的喜悦。"
    },
    {
        id: 9,
