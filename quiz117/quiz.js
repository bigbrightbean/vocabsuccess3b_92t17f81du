...
var questions = [
    {
        id: 1,
        question: "The manager decided to __________ the employee for his repeated tardiness and issued a formal warning.",
        chinese_question: "经理决定 __________ 员工多次迟到，并发出正式警告。",
        answers: [
    ...
    {
        id: 2,
        question: "The unexpected question from the audience seemed to __________ the speaker for a moment, causing him to lose his train of thought.",
        chinese_question: "观众的意外问题似乎让演讲者 __________ 了一会儿，让他失去了思路。",
        answers: [
    ...
    {
        id: 3,
        question: "The historian managed to __________ old letters that revealed important secrets about the past.",
        chinese_question: "历史学家设法 __________ 出揭示过去重要秘密的旧信件。",
        answers: [
            { option: "A", answer: "bury", chinese_answer: "埋葬", chinese_romanization: "mái zàng" },
            { option: "B", answer: "suppress", chinese_answer: "压制", chinese_romanization: "yā zhì" },
            { option: "C", answer: "conceal", chinese_answer: "隐藏", chinese_romanization: "yǐn cáng" },
            { option: "D", answer: "disinter", chinese_answer: "发掘", chinese_romanization: "fā jué" }
        ],
        correctAnswer: "D",
        explanation: "(D) 'disinter' means to discover or bring to light." +
            "<br><br>" +
            "(A) 'bury' means to hide something underground." +
            "<br><br>" +
            "(B) 'suppress' means to keep something from being known." +
            "<br><br>" +
            "(C) 'conceal' means to hide something from view.",
        chinese_explanation: "(D) '发掘' 意味着发现或揭示。" +
            "<br><br>" +
            "(A) '埋葬' 意味着把某物藏在地下。" +
            "<br><br>" +
            "(B) '压制' 意味着阻止某事被知道。" +
    ...
    {
        id: 10,
    question: "The preschool teacher decided to __________ on the side of caution by preparing extra snacks for the field trip, just in case the children got hungry.",
    chinese_question: "幼儿园老师决定 __________ ，为郊游准备额外的零食，以防孩子们饿了。",
    answers: [
        ...
        { option: "C", answer: "disregard", chinese_answer: "不顾", chinese_romanization: "bùgù" },
        { option: "D", answer: "err", chinese_answer: "犯错", chinese_romanization: "fàn cuò" }
    ],
    correctAnswer: "D",
    explanation: "(D) 'err' means to make a mistake or to choose cautiously." +
        "<br><br>" +
        "(A) 'neglect' means to fail to care for properly." +
        "<br><br>" +
        "(B) 'overlook' means to fail to notice or consider." +
        "<br><br>" +
        "(C) 'disregard' means to pay no attention to; ignore.",
    chinese_explanation: "(D) '犯错' 意味着犯错误或谨慎选择。" +
        "<br><br>" +
        "(A) '忽视' 意味着未能正确照顾。" +
        "<br><br>" +
        "(B) '忽略' 意味着未能注意或考虑。" +
