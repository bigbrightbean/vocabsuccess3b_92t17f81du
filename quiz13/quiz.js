...
var questions = [
    ...
    {
        id: 2,
        question: "His __________ approach to different cultures and respect for their traditions made him an excellent ambassador.",
        chinese_question: "他对不同文化的 __________ 态度以及对其传统的尊重使他成为一名出色的大使。",
        answers: [
    ...
    {
        id: 3,
        question: "Good leadership is __________ for the success of any organization and should be prioritized above all else.",
        chinese_question: "良好的领导对任何组织的成功都是__________的，应该放在所有事情之上。",
        answers: [
    ...
    {
        id: 5,
    question: "His decision to ignore the warning signs proved to be __________ for the project and resulted in significant setbacks and failures.",
    chinese_question: "他无视警告信号的决定对项目来说是__________的，导致了重大挫折和失败。",
    answers: [
    ...
    {
        id: 6,
        question: "Her __________ demeanour helped to defuse the tense situation in the meeting because she spoke calmly and sought common ground.",
        chinese_question: "她的 __________ 举止帮助缓和了会议中的紧张局面，因为她冷静地说话并寻求共同点。",
        answers: [
    ...
    {
        id: 7,
    question: "His __________ ideas about social reform were met with both enthusiasm and resistance because they challenged existing norms and proposed drastic changes.",
    chinese_question: "他关于社会改革的__________想法既受到热情的欢迎也遇到抵制，因为这些想法挑战了现有规范并提出了激烈的变化。",
    answers: [
    ...
    {
        id: 9,
    question: "Her __________ and well-planned efforts to improve her skills in her profession paid off when she received a promotion.",
    chinese_question: "她 __________ 并精心计划的在职业中提高技能的努力得到了回报，当她获得了晋升。",
    answers: [
