...
var questions = [
    {
        id: 1,
        question: "Her contributions to the project were __________, significantly advancing its progress.",
        chinese_question: "她对项目的贡献是 __________ 的，显著推进了项目进展。",
        answers: [
    ...
    {
        id: 4,
        question: "Her voice had an __________ quality that made the song soothing.",
        chinese_question: "她的声音具有__________的特点，使得这首歌听起来很舒缓。",
        answers: [
    ...
    {
        id: 6,
        question: "To ensure the __________ functioning of the machine, it is crucial to perform regular maintenance and inspections.",
        chinese_question: "为了确保机器的 __________ 运作，进行定期维护和检查是至关重要的。",
        answers: [
    ...
    {
        id: 9,
    question: "Her __________ retorts during debates made her a formidable opponent, always ready with a clever comeback.",
    chinese_question: "她在辩论中的 __________ 反驳让她成为一个强大的对手，总是准备好一个聪明的回击。",
    answers: [
    ...
    {
        id: 10,
    question: "His __________ ideas about business innovation often put him at odds with the more conservative members of the board.",
    chinese_question: "他关于商业创新的 __________ 想法经常使他与董事会中较为保守的成员产生分歧。",
    answers: [
