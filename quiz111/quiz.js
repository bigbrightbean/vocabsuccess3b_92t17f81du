...
var questions = [
    {
        id: 1,
        question: "He used every opportunity to __________ himself with the company's top executives.",
        chinese_question: "他利用每一个机会 __________ 自己与公司的高管们的关系。",
        answers: [
    ...
    {
        id: 2,
question: "The economic downturn __________ the government to implement new financial policies.",
chinese_question: "经济衰退 __________ 政府实施新的金融政策。",
answers: [
...
chinese_explanation: "(B) '共谋' 意味着秘密允许（某些被认为不道德、非法、错误或有害的事情）发生。" +
    ...
    {
        id: 4,
        question: "The pampered cat was __________ by its owner, receiving gourmet meals and constant attention.",
        chinese_question: "这只被宠坏的猫被它的主人 __________，享受美食和持续的关注。",
        answers: [
    ...
    {
        id: 5,
        question: "The artist's talent began to __________ during her time at the academy, gaining recognition from her peers.",
        chinese_question: "艺术家的才华在学院期间开始 __________ ，并获得了同龄人的认可。",
        answers: [
