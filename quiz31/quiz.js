...
var questions = [
    {
        id: 1,
        question: "Her __________ attention to detail ensured that nothing was overlooked in the project.",
        chinese_question: "她对细节的__________关注确保了项目中没有任何遗漏。",
        answers: [
            ...
            { option: "D", answer: "miniature", chinese_answer: "微小的", chinese_romanization: "wēixiǎo de" }
        ],
        correctAnswer: "D",
        explanation: "(D) 'miniature' means very small of its kind. Figuratively, it can mean focusing on very small and precise details." + 
            "<br><br>" + 
            "(A) 'large' means of considerable or relatively great size, extent, or capacity." + 
            "<br><br>" + 
            "(B) 'gigantic' means of very great size or extent; huge or enormous." + 
            "<br><br>" + 
            "(C) 'enormous' means very large in size, quantity, or extent.",
        chinese_explanation: "(D) '微小的'一词意味着非常小的。比喻地，它可以表示关注非常小和精确的细节。" +
            "<br><br>" +
            "(A) '大型的' 意味着相当大或相对较大的尺寸、范围或容量的。" +
            "<br><br>" +
            "(B) '巨大的' 意味着非常大的或巨大的。" +
            "<br><br>" +
            "(C) '庞大的' 意味着非常大的尺寸、数量或范围的."
    },
    {
        id: 2,
    ...
    {
        id: 3,
        question: "Her __________ comments often missed the point of the discussion entirely.",
        chinese_question: "她的__________评论常常完全错过讨论的要点。",
        answers: [
    ...
    {
        id: 4,
    question: "The argument was criticized as __________, failing to acknowledge the nuances of the issue at hand.",
    chinese_question: "这个论点被批评为 __________，未能承认手头问题的细微差别。",
    answers: [
    ...
    {
        id: 8,
        question: "Her contributions to the project were __________, significantly improving the team's overall performance and efficiency.",
        chinese_question: "她对项目的贡献非常 __________，显著提高了团队的整体表现和效率。",
        answers: [
