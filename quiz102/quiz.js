...
var questions = [
    {
        id: 1,
    question: "To __________ their old friendship, they decided to spend more time together, sharing memories and engaging in activities they used to enjoy.",
    chinese_question: "为了 __________ 旧友谊，他们决定花更多时间在一起，分享回忆并参与他们以前喜欢的活动。",
    answers: [
    ...
    {
        id: 2,
        question: "Trust is __________ in any strong and lasting relationship; without it, misunderstandings and conflicts can easily arise.",
        chinese_question: "信任在任何牢固而持久的关系中都是 __________ 的；没有它，误解和冲突很容易发生。",
        answers: [
    ...
    {
        id: 3,
        question: "She was unsure how to __________ the delicate subject of her friend's recent behavior, because discussing it might hurt their friendship.",
        chinese_question: "她不确定如何 __________ 她朋友最近行为的敏感话题，因为讨论它可能会伤害他们的友谊。",
        answers: [
    ...
    {
        id: 4,
    question: "The rebels were captured and __________ within the fortress walls, where they could neither escape nor communicate with the outside world.",
    chinese_question: "叛乱分子被捕并 __________ 在堡垒墙内，他们既不能逃脱也不能与外界联系。",
    answers: [
...
chinese_explanation: "(D) '吸引' 意味着捕捉或吸引某人的注意力。" +
    ...
    {
        id: 9,
        question: "When the newscaster announced the breaking news, her voice seemed to __________ through the newsroom, filling every corner.",
        chinese_question: "当新闻播报员宣布突发新闻时，她的声音似乎在新闻室 __________ ，充满了每一个角落。",
        answers: [
            { option: "A", answer: "absorb", chinese_answer: "吸收", chinese_romanization: "xī shōu" },
            { option: "B", answer: "muffle", chinese_answer: "压低", chinese_romanization: "yā dī" },
            { option: "C", answer: "suppress", chinese_answer: "抑制", chinese_romanization: "yì zhì" },
            { option: "D", answer: "reverberate", chinese_answer: "回荡", chinese_romanization: "huí dàng" }
        ],
        correctAnswer: "D",
        explanation: "(D) 'reverberate' means to echo or bounce back repeatedly." +
            "<br><br>" +
            "(A) 'absorb' means to take in or soak up." +
            "<br><br>" +
            "(B) 'muffle' means to make a sound quieter." +
            "<br><br>" +
            "(C) 'suppress' means to stop or put an end to something.",
        chinese_explanation: "(D) '回荡' 意味着反复回声或反弹。" +
            "<br><br>" +
            "(A) '吸收' 意味着吸收或吸取。" +
            "<br><br>" +
            "(B) '压低' 意味着使声音变得更小。" +
