...
var questions = [
    ...
    {
        id: 9,
        question: "Their __________ was a refreshing break from the tense atmosphere of the office, bringing smiles to their coworkers’ faces.",
        chinese_question: "他们的 __________ 是紧张的办公室气氛中的一股清流，给同事们带来了笑容。",
        answers: [
                ...
                { option: "C", answer: "seriousness", chinese_answer: "严肃", chinese_romanization: "yánsù" },
                { option: "D", answer: "formality", chinese_answer: "正式", chinese_romanization: "zhèngshì" }
        ],
        correctAnswer: "B",
        explanation: "(B) 'persiflage' means light and slightly contemptuous mockery or banter." +
                "<br><br>" +
                "(A) 'melancholy' means a feeling of pensive sadness, typically with no obvious cause." +
                "<br><br>" +
                "(C) 'seriousness' means the state of being serious." +
                "<br><br>" +
                "(D) 'formality' means the rigid observance of rules of convention or etiquette.",
        chinese_explanation: "(B) '打趣'一词意味着轻松且略带轻蔑的嘲弄或玩笑。" +
                "<br><br>" +
                "(A) '忧郁' 意味着一种典型地没有明显原因的沉思悲伤的感觉。" +
                "<br><br>" +
                "(C) '严肃' 意味着严肃的状态。" +
                "<br><br>" +
                "(D) '正式' 意味着严格遵守惯例或礼仪规则。"
