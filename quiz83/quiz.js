...
chinese_explanation: "(A) '关键人物' 意味着对企业或组织至关重要的人或事物。" +
    ...
    {
        id: 4,
        question: "The professor had a loyal __________ of students who admired his teachings and often stayed after class for discussions.",
        chinese_question: "这位教授有一群忠实的__________学生，他们钦佩他的教诲，常常在课后留下来讨论。",
        answers: [
            { option: "A", answer: "mob", chinese_answer: "暴民", chinese_romanization: "bàomín" },
            { option: "B", answer: "throng", chinese_answer: "一大群人", chinese_romanization: "yī dà qún rén" },
            { option: "C", answer: "rabble", chinese_answer: "乌合之众", chinese_romanization: "wūhé zhī zhòng" },
        ...
        explanation: "(D) 'coterie' means a small group of people with shared interests or tastes, especially one that is exclusive of other people." +
            "<br><br>" +
            "(A) 'mob' means a large and disorderly crowd of people, especially one bent on riotous or destructive action." +
            "<br><br>" +
            "(B) 'throng' means a large, densely packed crowd of people or animals." +
            "<br><br>" +
            "(C) 'rabble' means a disorderly crowd; a mob.",
        chinese_explanation: "(D) '小圈子' 意味着有共同兴趣或品味的一小群人，尤其是一个排他性的小圈子。" +
            "<br><br>" +
            "(A) '暴民' 意味着一群庞大而无秩序的人，尤其是一个倾向于骚乱或破坏性行动的人群。" +
            "<br><br>" +
            "(B) '一大群人' 意味着一个密集的、拥挤的群体。" +
            "<br><br>" +
            "(C) '乌合之众' 意味着一群无秩序的人群；暴民。"
    },
    {
        id: 5,
        question: "The salesperson's __________ was evident in his tactics, offering misleading information and exaggerated claims to close deals.",
        chinese_question: "这位销售员的__________在他的策略中显而易见，提供误导性的信息和夸大的说法来达成交易。",
        answers: [
            ...
            { option: "D", answer: "chicanery", chinese_answer: "欺骗", chinese_romanization: "qīpiàn" }
        ],
        correctAnswer: "D",
        explanation: "(D) 'chicanery' means the use of trickery to achieve a political, financial, or legal purpose." +
            "<br><br>" +
        ...
        chinese_explanation: "(D) '欺骗' 意味着使用诡计达到政治、经济或法律目的。" +
            "<br><br>" +
            "(A) '诚实' 意味着诚实的品质。" +
            "<br><br>" +
            "(B) '正直' 意味着诚实并具有坚定道德原则的品质。" +
            "<br><br>" +
            "(C) '透明' 意味着透明的状态。"
    },
    {
