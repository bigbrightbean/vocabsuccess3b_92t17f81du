...
var questions = [
    {
        id: 1,
    question: "Her __________ views on morality often clashed with the more liberal attitudes of her friends, who embraced modern ideas and unconventional lifestyles like cohabitation and non-traditional careers.",
    chinese_question: "她对道德的__________观点经常与她朋友更自由的态度发生冲突，这些朋友接受现代观念和非传统的生活方式，比如同居和非传统职业。",
    answers: [
    ...
    {
        id: 6,
        question: "Her decision to take the job was purely __________, driven by the high salary and benefits, rather than any passion for the work.",
        chinese_question: "她决定接受这份工作完全是出于 __________，是因为高薪和福利，而不是对工作的任何热情。",
        answers: [
            ...
            { option: "C", answer: "charitable", chinese_answer: "仁慈的", chinese_romanization: "réncí de" },
        ...
        explanation: "(D) 'pecuniary' means relating to or consisting of money." +
            "<br><br>" +
            "(A) 'altruistic' means showing a disinterested and selfless concern for the well-being of others." +
            "<br><br>" +
            "(B) 'philanthropic' means seeking to promote the welfare of others, especially by donating money to good causes." +
            "<br><br>" +
            "(C) 'charitable' means relating to the assistance of those in need.",
        chinese_explanation: "(D) '金钱的' 意味着与金钱有关或由金钱组成的。" +
            "<br><br>" +
            "(A) '利他的' 意味着表现出对他人福利的不感兴趣和无私的关心。" +
            "<br><br>" +
            "(B) '慈善的' 意味着寻求促进他人福利的，尤其是通过向公益事业捐款。" +
            "<br><br>" +
            "(C) '仁慈的' 意味着与帮助有需要的人有关。"
    },
    {
