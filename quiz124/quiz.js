...
var questions = [
    {
        id: 1,
        question: "The company decided to __________ a significant budget for the new project, by setting aside specific funds to ensure its success.",
        chinese_question: "公司决定为新项目 __________ 一笔可观的预算，通过预留特定资金来确保其成功。",
        answers: [
    ...
    {
        id: 2,
        question: "She was nervous to __________ her true feelings to him, because she feared his reaction when he found out.",
        chinese_question: "她紧张地 __________ 对他的真实感受，因为她害怕他知道后的反应。",
        answers: [
    ...
    {
        id: 3,
        question: "Her achievements were __________ proudly for everyone to see during the award ceremony, attracting attention and admiration from all around.",
        chinese_question: "她的成就被 __________ 给大家看，令人自豪，在颁奖典礼上吸引了所有人的注意和赞美。",
        answers: [
...
chinese_explanation: "(B) '使乏味' 一词在比喻上意味着导致失去热情和主动性。" +
    ...
    {
        id: 5,
        question: "Good hygiene practices can help __________ the spread of infectious diseases and reduce the risk of outbreaks.",
        chinese_question: "良好的卫生习惯可以帮助 __________ 传染病的传播，并减少爆发的风险。",
        answers: [
    ...
    {
        id: 6,
        question: "The slaves hoped that their master would eventually __________ them, granting them freedom from bondage.",
        chinese_question: "奴隶们希望主人最终会 __________ 他们，赋予他们从奴役中解放的自由。",
        answers: [
    ...
    {
        id: 7,
        question: "Despite the luxury, he felt __________ in his lavish mansion, as if he were imprisoned within its walls.",
        chinese_question: "尽管生活奢华，他在豪宅中感到 __________，仿佛被囚禁在其墙内。",
        answers: [
    ...
    {
        id: 8,
        question: "He was able to __________ the information from his colleague by pretending to be interested in his work and flattering his achievements.",
        chinese_question: "他通过假装对同事的工作感兴趣并奉承他的成就来 __________ 信息。",
        answers: [
    ...
    {
        id: 9,
        question: "The groundbreaking research __________ old theories, changing the way scientists view the phenomenon and opening new avenues for exploration.",
        chinese_question: "这项开创性的研究 __________ 了旧理论，改变了科学家们对这一现象的看法，并为探索开辟了新的途径。",
        answers: [
