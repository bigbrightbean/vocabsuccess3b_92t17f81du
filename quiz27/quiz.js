...
var questions = [
    ...
    {
        id: 5,
        question: "Their new policy is aimed at providing an __________ distribution of resources, where everyone receives a fair share and no group is left out.",
        chinese_question: "他们的新政策旨在提供__________的资源分配，确保每个人都得到公平的份额，没有任何群体被忽视。",
        answers: [
    ...
    {
        id: 6,
        question: "Her __________ behaviour at the party, such as interrupting conversations and speaking loudly, made others uncomfortable.",
        chinese_question: "她在派对上的__________行为，例如打断对话和大声说话，让其他人感到不舒服。",
        answers: [
