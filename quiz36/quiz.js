...
var questions = [
    {
        id: 1,
        question: "The team's __________ approach to the project, such as rushing decisions and overlooking details, resulted in numerous mistakes and setbacks.",
        chinese_question: "团队对项目的 __________ 方法，例如匆忙做决定和忽视细节，导致了许多错误和挫折。",
        answers: [
    ...
    {
        id: 5,
        question: "The __________ and overpowering smell coming from the garbage bin made it hard to stay in the room.",
        chinese_question: "垃圾桶里散发出的 __________ 且刺鼻的气味让人难以留在房间里。",
        answers: [
