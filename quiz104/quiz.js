...
var questions = [
  ...
  chinese_explanation: "(B) '暗示'一词意味着间接提及或提到。" +
    ...
    {
        id: 3,
question: "His smile __________ that he was pleased with the results.",
chinese_question: "他的微笑 __________ 他对结果感到满意。",
answers: [
    ...
    { option: "C", answer: "suggests", chinese_answer: "建议", chinese_romanization: "jiànyì" },
...
explanation: "(D) 'indicates' means to show or point out." +
    ...
    "<br><br>" +
    "(C) 'suggests' means to state or express indirectly.",
chinese_explanation: "(D) '表明' 意味着显示或指出。" +
    ...
    {
        id: 4,
        question: "The court decided to __________ the marriage due to evidence of fraud.",
        chinese_question: "由于欺诈证据，法院决定 __________ 这桩婚姻。",
        answers: [
    ...
    {
        id: 7,
        question: "Protesters were accused of trying to __________ the national flag during the demonstration.",
        chinese_question: "抗议者被指控在示威期间试图 __________ 国旗。",
        answers: [
