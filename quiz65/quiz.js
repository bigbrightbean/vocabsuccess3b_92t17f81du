...
var questions = [
    {
        id: 1,
        question: "To their __________, the board members discovered that the budget had been drastically cut without their knowledge.",
        chinese_question: "令董事会成员 __________ 的是，他们发现预算在他们不知情的情况下被大幅削减了。",
        answers: [
                ...
                { option: "C", answer: "anticipation", chinese_answer: "预期", chinese_romanization: "yùqí" },
    ...
    {
        id: 9,
    question: "The frustrated customer unleashed a torrent of __________ on the support staff, using harsh and abusive language to express his dissatisfaction with the service.",
    chinese_question: "那位心烦意乱的顾客对客服人员发起了一连串的 __________，用尖刻和辱骂的语言表达他对服务的不满。",
    answers: [
        { option: "A", answer: "compliments", chinese_answer: "赞美", chinese_romanization: "zànměi" },
        { option: "B", answer: "commendations", chinese_answer: "表扬", chinese_romanization: "biǎoyáng" },
        { option: "C", answer: "praises", chinese_answer: "赞扬", chinese_romanization: "zànyáng" },
        { option: "D", answer: "vituperations", chinese_answer: "谩骂", chinese_romanization: "mànmà" }
    ],
    correctAnswer: "D",
    explanation: "(D) 'vituperations' means bitter and abusive language." +
        "<br><br>" +
        "(A) 'compliments' means polite expressions of praise or admiration." +
        "<br><br>" +
        "(B) 'commendations' means praise formally or officially." +
        "<br><br>" +
        "(C) 'praises' means expressions of approval or admiration.",
    ...
    {
        id: 10,
    question: "As the honorary advisor, his role was mostly a __________, drawing a substantial paycheck without having to perform any significant duties.",
    chinese_question: "作为名誉顾问，他的职位大多是一个 __________，领取可观的薪水而无需履行任何重大职责。",
    answers: [
