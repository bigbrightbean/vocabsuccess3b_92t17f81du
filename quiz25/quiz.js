...
var questions = [
    ...
    {
        id: 2,
        question: "His __________ behavior at the meeting shocked everyone, as he aggressively interrupted others and dismissed their ideas.",
        chinese_question: "他在会议上的 __________ 行为震惊了所有人，因为他咄咄逼人地打断别人并否定他们的想法。",
        answers: [
    ...
    {
        id: 3,
        question: "Her __________ manner made even casual dinners feel like grand occasions.",
        chinese_question: "她 __________ 的举止使即使是随意的晚餐也感觉像是盛大的场合。",
        answers: [
    ...
    {
        id: 5,
        question: "His __________ agreement to the proposal showed his lack of commitment.",
        chinese_question: "他对提案的__________同意表明他缺乏承诺。",
        answers: [
    ...
    {
        id: 6,
        question: "In today's global economy, being __________ can provide a significant advantage in the job market.",
        chinese_question: "在当今的全球经济中，__________ 可以在就业市场上提供显著的优势。",
        answers: [
    ...
    {
        id: 7,
    question: "Her __________ attitude at work often led to conflicts with her supervisors.",
    chinese_question: "她在工作中的__________态度经常导致与上司的冲突。",
    answers: [
    ...
    {
        id: 8,
        question: "The plot of the novel was __________, filled with bizarre twists and unexpected events.",
        chinese_question: "小说的情节非常 __________，充满了离奇的转折和意外的事件。",
        answers: [
        ...
        correctAnswer: "C",
        explanation: "(C) 'grotesque' means comically or repulsively ugly or distorted. Figuratively, it can mean strange and unpleasant." + 
            "<br><br>" +
        ...
        chinese_explanation: "(C) '丑陋的'一词意味着滑稽地或令人厌恶地丑陋或扭曲的。比喻地，它可以表示奇怪和令人不愉快的。" + 
            "<br><br>" +
