...
var questions = [
    ...
    {
        id: 2,
        question: "During a heated argument with his friend, the angry teenager threatened to __________ his phone out of the car window when his friend wanted him to calm down.",
        chinese_question: "在与朋友的激烈争吵中，愤怒的少年威胁要把他的手机 __________ 出车窗，当时他的朋友想让他冷静下来。",
        answers: [
            { option: "A", answer: "retrieve", chinese_answer: "取回", chinese_romanization: "qǔ huí" },
            { option: "B", answer: "assemble", chinese_answer: "组装", chinese_romanization: "zǔ zhuāng" },
        ...
        explanation: "(D) 'defenestrate' means to throw someone or something out of a window." +
            "<br><br>" +
            "(A) 'retrieve' means to get something back." +
            "<br><br>" +
            "(B) 'assemble' means to put something together." +
            "<br><br>" +
            "(C) 'conceal' means to hide something.",
    ...
    {
        id: 4,
        question: "During the meeting, they began to __________ ideas for the new project by discussing various approaches and brainstorming potential solutions.",
        chinese_question: "在会议期间，他们通过讨论各种方法和集思广益潜在的解决方案开始 __________ 新项目的想法。",
        answers: [
...
chinese_explanation: "(B) '安抚' 意味着安慰或平息某人的愤怒或焦虑。" +
    ...
    {
        id: 6,
    question: "Even though he had reservations, his silence was __________ as agreement to the proposal, and they proceeded with the plan.",
    chinese_question: "即使他有保留意见，他的沉默也被 __________ 为同意该提议，他们继续执行计划。",
        answers: [
