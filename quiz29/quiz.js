...
var questions = [
    ...
    {
        id: 2,
        question: "Her __________ bursts of creativity, which came only when she felt inspired and had some quiet time, always brought fresh ideas to the project.",
        chinese_question: "她的__________创意爆发，总是在她感到灵感和有些安静时间时出现，总是为项目带来新想法。",
        answers: [
    ...
    {
        id: 4,
            question: "His __________ response to constructive criticism, such as becoming angry and dismissive, made it difficult for others to work with him.",
            chinese_question: "他对建设性批评的 __________ 反应，比如变得愤怒和不屑，使得别人很难与他共事。",
            answers: [
    ...
    {
        id: 5,
        question: "His __________ handwriting, with uneven and sharp letters scattered across the page, made it difficult for others to read his notes.",
        chinese_question: "他的 __________ 字迹，页面上散布着不均匀和尖锐的字母，使别人难以阅读他的笔记。",
        answers: [
    ...
    {
        id: 6,
    question: "Having played with unwavering focus and determination, the team's __________ effort to win the championship paid off.",
    chinese_question: "他们以坚定不移的专注和决心进行比赛，团队赢得冠军的 __________ 努力得到了回报。",
    answers: [
    ...
    {
        id: 10,
        question: "Her __________ remarks during the meeting, like insulting her colleagues and criticizing the project harshly, left everyone in shock.",
        chinese_question: "她在会议上的 __________ 言论，比如侮辱同事和严厉批评项目，让所有人震惊。",
        answers: [
