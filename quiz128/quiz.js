...
var questions = [
    {
        id: 1,
        question: "The judge decided to __________ the witness by having them testify under oath and providing a detailed account, so as to gather more information about the case.",
        chinese_question: "法官决定 __________ 证人，通过让他们宣誓作证并提供详细陈述，以便收集更多有关案件的信息。",
        answers: [
...
chinese_explanation: "(B) '确定' 意味着确认或确定。" +
    ...
    {
        id: 4,
      question: "Despite the potential risks, she did not __________, showing no hesitation or reluctance, when offered the challenging assignment.",
      chinese_question: "尽管存在潜在风险，但当被提供挑战性任务时，她没有 __________，表现出任何犹豫或不情愿。",
      answers: [
    ...
    {
        id: 5,
        question: "The surveyors needed to __________ the boundaries of the property, using their instruments to determine the location with the positions of three known points.",
        chinese_question: "测量员需要 __________ 物业的边界，使用他们的仪器通过使用三个已知点的位置来确定位置。",
        answers: [
    ...
    {
        id: 6,
        question: "If not cleaned regularly, dust and debris will __________ in the corners of the room over time, forming noticeable clumps and layers.",
        chinese_question: "如果不定期清理，灰尘和碎屑会随着时间的推移在房间的角落里 __________，并形成明显的团块和层。",
        answers: [
    ...
    {
        id: 7,
        question: "In the jungle, certain species of primates __________ to travel quickly and efficiently, by swinging from tree branch to tree branch using their arms.",
        chinese_question: "在丛林中，某些灵长类动物通过用手臂从一个树枝摆荡到另一个树枝来快速高效地旅行。",
        answers: [
    ...
    {
        id: 8,
        question: "To meet the increasing demand, the company decided to __________ more units of the popular gadget, by ramping up production in their factories.",
        chinese_question: "为了满足日益增长的需求，公司决定通过在工厂增加生产来 __________ 更多受欢迎的小工具。",
        answers: [
    ...
    {
        id: 9,
        question: "The political movement began to __________, losing its momentum and influence, when key leaders left to pursue other interests.",
        chinese_question: "当主要领导人离开追求其他兴趣时，政治运动开始 __________，失去动力和影响力。",
        answers: [
    ...
    {
        id: 10,
        question: "In his quest for perfection, he would often __________ himself for not meeting his own high standards, by mentally punishing himself and dwelling on his perceived failures.",
        chinese_question: "在追求完美的过程中，他经常会因为未达到自己的高标准而 __________ 自己，通过精神上惩罚自己和沉溺于自己认为的失败。",
        answers: [
