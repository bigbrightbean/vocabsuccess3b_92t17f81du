...
var questions = [
    {
        id: 1,
    question: "Her __________ way of explaining things often left people confused and lost.",
    chinese_question: "她__________的解释方式经常让人感到困惑和迷茫。",
    answers: [
    ...
    correctAnswer: "C",
    explanation: "(C) 'serpentine' means of or like a serpent or snake; winding and twisting like a snake. Figuratively, it can mean being complex, cunning, or intricate." +
        "<br><br>" +
    ...
    chinese_explanation: "(C) '曲折的'一词意味着像蛇或蛇一样的；像蛇一样蜿蜒和扭曲的。比喻地，它可以表示复杂、狡猾或错综复杂的。" +
        "<br><br>" +
    ...
    {
        id: 9,
        question: "The __________ theme in his artwork is the struggle between light and dark, evident in almost every piece.",
    ...
    {
        id: 10,
    question: "His __________ faith in the mission inspired everyone around him, giving them the courage to persevere despite the challenges.",
    chinese_question: "他对任务的 __________ 信念激励了周围的每个人，给了他们克服挑战的勇气。",
    answers: [
