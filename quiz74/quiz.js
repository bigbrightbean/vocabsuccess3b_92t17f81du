...
var questions = [
    ...
    {
        id: 4,
        question: "The philosopher's __________ on living a meaningful life, such as cultivating virtue and seeking wisdom, resonated with many readers and prompted deep reflection.",
        chinese_question: "哲学家关于过有意义生活的 __________，例如培养美德和追求智慧，引起了许多读者的共鸣，促使他们深思。",
        answers: [
    ...
    {
        id: 9,
        question: "The __________ of change in the industry has accelerated due to technological advancements, resulting in increased productivity and innovation.",
        chinese_question: "由于技术进步，行业变化的 __________ 加快了，导致生产力和创新能力的提高。",
        answers: [
    ...
    {
        id: 10,
        question: "The __________ in the marketplace was overwhelming because it was filled with loud chatter and bustling activity, making it hard to focus on any one vendor.",
        chinese_question: "市场上的 __________ 令人难以承受，因为充满了嘈杂的谈话和繁忙的活动，让人难以专注于任何一个商贩。",
        answers: [
