...
var questions = [
    ...
    {
        id: 3,
        question: "The spread of the virus was __________ and swift, infecting thousands of people in just a few days.",
        chinese_question: "病毒的传播是 __________ 且迅速的，仅在几天内就感染了成千上万的人。",
        answers: [
    ...
    {
        id: 5,
    question: "Her __________ leadership style left no room for doubt or second-guessing, thereby inspiring confidence in her team.",
    chinese_question: "她 __________ 的领导风格不容置疑或猜测，从而激发了团队的信心。",
    answers: [
    ...
    {
        id: 8,
        question: "The politician's __________ promises, such as ending poverty and eliminating national debt, were hard to believe and even harder to achieve.",
        chinese_question: "这位政客的 __________ 承诺，比如消除贫困和消除国家债务，很难相信，更难实现。",
        answers: [
    ...
    {
        id: 9,
        question: "His __________ emotions, such as his fear of abandonment and sadness over lost opportunities, were evident when he spoke about his childhood.",
        chinese_question: "当他谈到自己的童年时，他的 __________ 情感显露无遗，比如他对被抛弃的恐惧和对失去机会的悲伤。",
        answers: [
    ...
    {
        id: 10,
        question: "Her __________ role in the project as the lead strategist made her the go-to person for any major decisions and problem-solving.",
        chinese_question: "她在项目中的 __________ 角色作为首席战略家，使她成为任何重大决策和解决问题的首选人。",
        answers: [
