...
var questions = [
    ...
    },
    {
        ...
        answers: [
            { option: "A", answer: "wave", chinese_answer: "波浪", chinese_romanization: "bōlàng" },
            { option: "B", answer: "glimmer", chinese_answer: "微光", chinese_romanization: "wéiguāng" },
            { option: "C", answer: "flood", chinese_answer: "洪水", chinese_romanization: "hóngshuǐ" },
            { option: "D", answer: "tide", chinese_answer: "潮汐", chinese_romanization: "cháoxī" }
        ],
        correctAnswer: "B",
        explanation: "(B) 'glimmer' means a faint or wavering light, often used figuratively to indicate a slight or initial indication of something." +
            "<br><br>" +
            "(A) 'wave' means a long body of water curling into an arched form and breaking on the shore." +
            "<br><br>" +
            "(C) 'flood' means an overflow of a large amount of water beyond its normal limits." +
            "<br><br>" +
            "(D) 'tide' means the alternate rising and falling of the sea.",
        chinese_explanation: "(B) '微光' 意味着微弱或摇曳的光，通常用于比喻表示某事物的轻微或初步迹象。" +
            "<br><br>" +
            "(A) '波浪' 意味着水体长长的弯曲形成并在海岸上破裂。" +
            "<br><br>" +
            "(C) '洪水' 意味着大量水溢出其正常界限。" +
            "<br><br>" +
            "(D) '潮汐' 意味着海水交替升降。"
    ...
    {
        id: 9,
        question: "Her __________ reputation in the community made her a trusted and respected figure.",
        chinese_question: "她在社区中的 __________ 声誉使她成为一个值得信任和尊敬的人物。",
        answers: [
