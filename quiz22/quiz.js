...
var questions = [
    ...
    {
        id: 2,
    question: "Her __________ behavior in the office, like constantly flattering her superiors and volunteering for menial tasks, made her colleagues see her as someone who would do anything to please the higher-ups, even at her own expense.",
    chinese_question: "她在办公室的 __________ 行为，例如不断拍上司的马屁，主动承担琐碎的任务，让同事们认为她是一个会不惜一切取悦上司的人，即使是以牺牲自己为代价。",
    answers: [
    ...
    {
        id: 3,
        question: "His __________ praise made the employees feel unappreciated.",
        chinese_question: "他 __________ 的赞美让员工们感到不被重视。",
        answers: [
    ...
    {
        id: 4,
        question: "His __________ attitude towards his new job made every day at work enjoyable.",
        chinese_question: "他对新工作的 __________ 态度使得每天的工作都很愉快。",
        answers: [
    ...
    {
        id: 5,
        question: "His actions were clearly __________, as he had planned every detail meticulously to achieve his goal.",
        chinese_question: "他的行为显然是 __________ 的，因为他为了实现目标，精心计划了每一个细节。",
        answers: [
    ...
    {
        id: 6,
        question: "His __________ discipline in managing the team led to their outstanding performance.",
        chinese_question: "他在管理团队时的 __________ 纪律导致了他们的出色表现。",
        answers: [
    ...
    {
        id: 8,
        question: "The __________ candidate for the job had both the required qualifications and experience.",
        chinese_question: "那位 __________ 的求职者既具备所需的资格又有经验。",
        answers: [
    ...
    {
        id: 9,
        question: "The scandal left many voters feeling __________ about their leaders and the promises they made.",
        chinese_question: "丑闻让许多选民对他们的领导人和他们所做的承诺感到 __________。",
        answers: [
    ...
    {
        id: 10,
    question: "Her __________ remarks to the influential guest were intended to secure a promotion, but they only served to embarrass her colleagues.",
    chinese_question: "她对有影响力的客人的 __________ 言辞意在确保升职，但只让她的同事们感到尴尬。",
    answers: [
