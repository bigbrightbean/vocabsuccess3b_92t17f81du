...
var questions = [
    ...
    {
        id: 5,
    question: "The manager's constant __________ about deadlines made the employees anxious.",
    chinese_question: "经理对截止日期的不断 __________ 让员工感到焦虑。",
    answers: [
    ...
    {
        id: 9,
        question: "His decision to speak out against the injustice was a __________ he knew could cost him his job.",
        chinese_question: "他决定对不公正现象发声，这是一种他知道可能会让他丢掉工作的 __________。",
        answers: [
        ...
        explanation: "(B) 'risk' means a situation involving exposure to danger." +
                ...
                "<br><br>" +
                "(C) 'certainty' means the state of being sure or confident." +
                "<br><br>" +
