...
var questions = [
    {
        ...
        answers: [
            ...
            { option: "C", answer: "behavior", chinese_answer: "行为", chinese_romanization: "xíngwéi" },
        ...
        explanation: "(B) 'countenance' means a person's face or facial expression, especially as an indicator of mood or emotion." +
                ...
                "<br><br>" +
                "(C) 'behavior' means the way in which one acts or conducts oneself." +
                "<br><br>" +
    ...
    },
    {
        ...
        answers: [
                ...
                { option: "C", answer: "bridge", chinese_answer: "桥梁", chinese_romanization: "qiáoliáng" },
        ...
        explanation: "(D) 'liaison' means communication or cooperation that facilitates a close working relationship between people or organizations." +
                ...
                "<br><br>" +
                "(C) 'bridge' means a structure carrying a road, path, railroad, or canal across a river, ravine, road, railroad, or other obstacle.",
        chinese_explanation: "(D) '联络员'一词意味着促进人或组织之间紧密工作关系的沟通或合作。" +
                ...
                "<br><br>" +
                "(C) '桥梁' 意味着承载道路、路径、铁路或运河穿过河流、峡谷、道路、铁路或其他障碍物的结构。"
    },
    {
        id: 3,
    ...
    {
        id: 6,
        question: "The politician's __________ during the debate showcased his sharp mind and sense of humor, winning over many undecided voters.",
        chinese_question: "这位政治家在辩论中的 __________ 展示了他的机智和幽默感，赢得了许多未决定选民的支持。",
        answers: [
