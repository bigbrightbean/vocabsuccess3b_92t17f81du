...
var questions = [
    ...
    {
        id: 5,
      question: "Despite having gone through the complex procedure several times, the nurse took a moment to ______ the main steps to ensure everyone understood.",
      chinese_question: "尽管已经多次进行复杂的程序，这名护士还是花了一些时间来______主要步骤，以确保每个人都明白。",
      answers: [
      ...
      explanation: "(A) 'recapitulate' means to summarize and restate the main points." +
        ...
        "<br><br>" +
        "(C) 'confuse' means to make someone unable to think clearly or understand something." +
        "<br><br>" +
        "(D) 'dismiss' means to order or allow to leave; send away.",
      chinese_explanation: "(A) '概述' 意味着总结并重述主要观点。" +
        "<br><br>" +
        "(B) '使复杂化' 意味着使某事变得更困难或令人困惑。" +
        "<br><br>" +
        "(C) '使困惑' 意味着使某人无法清楚地思考或理解某事。" +
        "<br><br>" +
        "(D) '驳回' 意味着命令或允许离开；送走。"
    },
    {
    ...
    {
        id: 7,
        question: "He hopes to __________ the art of negotiations and become an expert to advance his career.",
        chinese_question: "他希望 __________ 谈判艺术，并成为专家以推进他的职业生涯。",
        answers: [
    ...
    {
        id: 8,
        question: "He felt __________ by the expectations placed on him by his family, who expected him to excel in academics and follow a prestigious career path.",
        chinese_question: "他感到被家庭对他的期望所 __________，家庭期望他在学术上出类拔萃，并走上一条有声望的职业道路。",
        answers: [
