...
var questions = [
    ...
    {
        id: 5,
        question: "His __________ approach to management, like ensuring fair work hours and offering mental health support, earned him the respect and loyalty of his employees.",
        chinese_question: "他 __________ 的管理方法，比如确保公平的工作时间和提供心理健康支持，赢得了员工的尊重和忠诚。",
        answers: [
    ...
    {
        id: 8,
        question: "In the hospital, despite the relentless treatments, the cancer survivor's spirit remained ______, inspiring everyone around her.",
        chinese_question: "在医院里，尽管接受了无情的治疗，这位癌症幸存者的精神依然______, 鼓舞了她周围的每一个人。",
        answers: [
    ...
    {
        id: 9,
    question: "Her __________ attitude toward the new employees, such as making snide remarks and giving them menial tasks, created a hostile work environment.",
    chinese_question: "她对新员工的 __________ 态度，例如挖苦和分配给他们琐碎的任务，营造了一个敌对的工作环境。",
    answers: [
