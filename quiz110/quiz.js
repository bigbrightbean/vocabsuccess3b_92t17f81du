...
var questions = [
    {
        id: 1,
        question: "To understand the full picture, one must __________ the past events with the present circumstances.",
        chinese_question: "要理解全貌，必须将过去的事件与当前的情况 __________ 在一起。",
        answers: [
...
chinese_explanation: "(A) '努力应对' 意味着努力处理或克服某事。" +
    ...
    {
        id: 6,
  question: "His curiosity __________ him to ask questions during the lecture.",
  chinese_question: "他的好奇心 __________ 他在讲座期间提问。",
  answers: [
    { option: "A", answer: "prompted", chinese_answer: "促使", chinese_romanization: "cùshǐ" },
    { option: "B", answer: "stifled", chinese_answer: "扼杀", chinese_romanization: "èshā" },
  ...
  explanation: "(A) 'prompted' figuratively means to cause or bring about (an action or feeling)." +
    "<br><br>" +
    "(B) 'stifled' means to make someone unable to breathe properly; suffocate." +
    "<br><br>" +
  ...
  chinese_explanation: "(A) '促使' 在此语境下比喻导致或引起（一个行动或感觉）。" +
    ...
    {
        id: 7,
        question: "Greedy developers sought to __________ the historic neighborhood for their new high-rise project.",
        chinese_question: "贪婪的开发商企图 __________ 这个历史街区来进行他们的新高层项目。",
        answers: [
    ...
    {
        id: 8,
        question: "The strong wind __________ leaves all over the yard.",
        chinese_question: "大风把树叶 __________ 在整个院子里。",
        answers: [
    ...
    {
        id: 9,
        question: "The chairman decided to __________ a special meeting to address the urgent issues.",
        chinese_question: "主席决定 __________ 一次特别会议来解决紧急问题。",
        answers: [
    ...
    {
        id: 10,
question: "Years of corruption had __________ the integrity of the political system.",
chinese_question: "多年的腐败已经 __________ 了政治体制的完整性。",
answers: [
