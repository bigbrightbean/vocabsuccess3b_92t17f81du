...
var questions = [
    ...
    {
        id: 3,
    question: "The reviewer's __________ comments about the book made it clear that he didn't appreciate the author's style.",
    chinese_question: "评论者对这本书的 __________ 评论表明他不喜欢作者的风格。",
    answers: [
    ...
    {
        id: 5,
        question: "Her __________ friend revealed her secrets to others, causing a deep sense of betrayal.",
        chinese_question: "她那 __________ 的朋友把她的秘密透露给了别人，导致了一种深深的背叛感。",
        answers: [
    ...
    {
        id: 9,
        question: "Her reputation remained __________ despite the many rumors and accusations, reflecting her integrity and honesty.",
        chinese_question: "尽管有很多谣言和指控，她的声誉依然 __________，反映了她的正直和诚实。",
        answers: [
    ...
    {
        id: 10,
        question: "In the face of criticism, she maintained a __________ demeanour, responding calmly and respectfully.",
        chinese_question: "面对批评，她保持了 __________ 的态度，冷静而恭敬地回应。",
        answers: [
