...
var questions = [
    {
        id: 1,
    question: "He had a knack for __________ out the best deals in town, always managing to find hidden bargains and discounts.",
    chinese_question: "他擅长在城里 __________ 出最好的交易，总能找到隐藏的便宜货和折扣。",
    answers: [
...
chinese_explanation: "(B) '挣扎' 意味着做出强烈或激烈的努力以摆脱束缚或限制。" +
    ...
    {
        id: 4,
        question: "The writer aims to __________ thought-provoking stories that challenge societal norms, using his platform to spread innovative ideas.",
        chinese_question: "这位作家旨在 __________ 引人深思的故事，挑战社会规范，利用他的平台传播创新的想法。",
        answers: [
            ...
            { option: "C", answer: "purvey", chinese_answer: "传播", chinese_romanization: "chuánbō" },
            { option: "D", answer: "ignore", chinese_answer: "忽视", chinese_romanization: "hūshì" }
        ],
        correctAnswer: "C",
        explanation: "(C) 'purvey' means to supply or spread information or ideas." +
            "<br><br>" +
            "(A) 'suppress' means to forcibly put an end to." +
            "<br><br>" +
            "(B) 'obscure' means to keep from being seen." +
            "<br><br>" +
            "(D) 'ignore' means to refuse to take notice of.",
        chinese_explanation: "(C) '传播' 意味着提供或传播信息或观点。" +
            "<br><br>" +
            "(A) '压制' 意味着强行结束。" +
            "<br><br>" +
            "(B) '遮掩' 意味着防止被看到。" +
    ...
    {
        id: 5,
        question: "The monks decided to __________ themselves in the monastery to focus on their spiritual practices, isolating themselves from the outside world.",
        chinese_question: "僧侣们决定 __________ 在修道院中，专注于他们的灵修，与外界隔绝。",
        answers: [
    ...
    {
        id: 6,
        question: "The scientist had to __________ the chemical solution by carefully pouring it to avoid disturbing any sediment, so as to ensure it was free of impurities.",
        chinese_question: "科学家必须通过小心倒出化学溶液，以避免扰动任何沉淀物，从而确保其无杂质。",
        answers: [
    ...
    },
    {
        ...
        answers: [
                { option: "A", answer: "replenished", chinese_answer: "补充", chinese_romanization: "bǔchōng" },
                ...
                { option: "D", answer: "enfeebled", chinese_answer: "使虚弱", chinese_romanization: "shǐ xūruò" }
        ],
        correctAnswer: "D",
        explanation: "(D) 'enfeebled' means to make very weak, used figuratively here." +
            "<br><br>" +
            "(A) 'replenished' means to fill something up again." +
            "<br><br>" +
            "(B) 'ignored' means to refuse to take notice of or acknowledge." +
            "<br><br>" +
            "(C) 'improved' means to make or become better.",
        chinese_explanation: "(D) '使虚弱' 意味着使非常虚弱，这里是比喻用法。" +
            "<br><br>" +
            "(A) '补充' 意味着再次填满某物。" +
            "<br><br>" +
            "(B) '忽视' 意味着拒绝注意或承认。" +
    ...
    {
        id: 8,
    question: "The detective found evidence that could __________ the suspect in the crime by linking them directly to the scene.",
    chinese_question: "侦探找到了可能通过将嫌犯直接与现场联系起来 __________ 嫌犯犯罪的证据。",
    answers: [
    ...
    {
        id: 9,
        question: "The program aims to __________ young entrepreneurs with the skills they need to succeed, by offering training and mentorship.",
        chinese_question: "该项目旨在通过提供培训和指导来 __________ 年轻企业家所需的技能，使他们能够成功。",
        answers: [
            { option: "A", answer: "confuse", chinese_answer: "迷惑", chinese_romanization: "míhuò" },
            { option: "B", answer: "restrict", chinese_answer: "限制", chinese_romanization: "xiànzhì" },
            { option: "C", answer: "endow", chinese_answer: "赋予", chinese_romanization: "fùyǔ" },
            { option: "D", answer: "neglect", chinese_answer: "忽视", chinese_romanization: "hūshì" }
        ],
        correctAnswer: "C",
        explanation: "(C) 'endow' figuratively means to provide with a quality, ability, or asset." +
            "<br><br>" +
            "(A) 'confuse' means to make (someone) unable to think clearly." +
            "<br><br>" +
            "(B) 'restrict' means to put a limit on; keep under control." +
            "<br><br>" +
            "(D) 'neglect' means to fail to care for properly.",
        chinese_explanation: "(C) '赋予' 在此语境下比喻提供一种品质、能力或资产。" +
            "<br><br>" +
            "(A) '迷惑' 意味着使某人无法清晰思考。" +
            "<br><br>" +
            "(B) '限制' 意味着对某物进行限制；控制。" +
    ...
    {
        id: 10,
        question: "She managed to __________ the project through various challenges to success, by skillfully guiding the team and making strategic decisions.",
        chinese_question: "她设法将项目 __________ 通过各种挑战实现成功，通过巧妙地引导团队并做出战略决策。",
        answers: [
