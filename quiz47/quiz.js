...
var questions = [
    {
        id: 1,
        question: "His __________ comments were meant to undermine his colleague's confidence.",
        chinese_question: "他的 __________ 评论旨在削弱他同事的信心。",
        answers: [
    ...
    {
        id: 2,
        question: "Her __________ explanation made the complex topic easy to understand for everyone.",
        chinese_question: "她的__________解释让每个人都能轻松理解这个复杂的话题。",
        answers: [
    ...
    {
        id: 3,
        question: "His knowledge of the subject seemed __________, impressing even the experts.",
        chinese_question: "他对这个主题的知识似乎是__________的，甚至让专家们都印象深刻。",
        answers: [
            { option: "A", answer: "limited", chinese_answer: "有限的", chinese_romanization: "yǒuxiàn de" },
            { option: "B", answer: "unfathomable", chinese_answer: "深不可测的", chinese_romanization: "shēn bùkě cè de" },
        ...
        chinese_explanation: "(B) '深不可测的' 意味着无法完全探索或理解的。" +
            "<br><br>" +
    ...
    {
        id: 5,
        question: "The teacher emphasized the __________ sources for the research paper, which included textbooks and scholarly articles.",
        chinese_question: "老师强调了研究论文的 __________ 来源，包括教科书和学术文章。",
        answers: [
