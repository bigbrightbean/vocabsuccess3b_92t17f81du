...
var questions = [
    ...
    {
        id: 2,
        question: "The novel explored the __________ relationships of its characters, highlighting the consequences of their actions.",
        chinese_question: "这部小说探讨了角色们的 __________ 关系，突出了他们行为的后果。",
        answers: [
    ...
    {
        id: 3,
        question: "Her __________ views on life made her an intriguing person to talk to.",
        chinese_question: "她对生活的__________观点使她成为一个有趣的谈话对象。",
        answers: [
    ...
    {
        id: 4,
        question: "She is __________ to taking on too much work, often leading to burnout.",
        chinese_question: "她 __________ 接受过多的工作，常常导致精疲力竭。",
        answers: [
    ...
    {
        id: 9,
        question: "Despite her glamorous career, she had to deal with many __________ tasks behind the scenes.",
        chinese_question: "尽管她的职业很光鲜亮丽，但她还是要处理很多幕后的 __________ 任务。",
        answers: [
    ...
    {
        id: 10,
        question: "Her __________ disposition made her a joy to be around, always brightening up the mood of those she encountered.",
        chinese_question: "她 __________ 的性格使她成为一个令人愉快的人，总是能让遇到的人心情愉快。",
        answers: [
